...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.SliderColumnFormat();
  });
  ...
  describe('SliderColumnFormat', function() {
    it('should create an instance of SliderColumnFormat', function() {
      // uncomment below and update the code to test SliderColumnFormat
      //var instane = new CodaJsClient.SliderColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.SliderColumnFormat);
    });
