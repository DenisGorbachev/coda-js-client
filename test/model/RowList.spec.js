...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.RowList();
  });
  ...
  describe('RowList', function() {
    it('should create an instance of RowList', function() {
      // uncomment below and update the code to test RowList
      //var instane = new CodaJsClient.RowList();
      //expect(instance).to.be.a(CodaJsClient.RowList);
    });
