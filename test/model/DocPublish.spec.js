...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocPublish();
  });
  ...
  describe('DocPublish', function() {
    it('should create an instance of DocPublish', function() {
      // uncomment below and update the code to test DocPublish
      //var instane = new CodaJsClient.DocPublish();
      //expect(instance).to.be.a(CodaJsClient.DocPublish);
    });
