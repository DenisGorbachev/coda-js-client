...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.FormulaReference();
  });
  ...
  describe('FormulaReference', function() {
    it('should create an instance of FormulaReference', function() {
      // uncomment below and update the code to test FormulaReference
      //var instane = new CodaJsClient.FormulaReference();
      //expect(instance).to.be.a(CodaJsClient.FormulaReference);
    });
