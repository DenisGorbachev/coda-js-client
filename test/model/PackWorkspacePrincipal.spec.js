...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackWorkspacePrincipal();
  });
  ...
  describe('PackWorkspacePrincipal', function() {
    it('should create an instance of PackWorkspacePrincipal', function() {
      // uncomment below and update the code to test PackWorkspacePrincipal
      //var instane = new CodaJsClient.PackWorkspacePrincipal();
      //expect(instance).to.be.a(CodaJsClient.PackWorkspacePrincipal);
    });
