...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PageUpdate();
  });
  ...
  describe('PageUpdate', function() {
    it('should create an instance of PageUpdate', function() {
      // uncomment below and update the code to test PageUpdate
      //var instane = new CodaJsClient.PageUpdate();
      //expect(instance).to.be.a(CodaJsClient.PageUpdate);
    });
    ...
    it('should have the property iconName (base name: "iconName")', function() {
