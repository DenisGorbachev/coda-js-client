...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.RowValue();
  });
  ...
  describe('RowValue', function() {
    it('should create an instance of RowValue', function() {
      ...
      //var instane = new CodaJsClient.RowValue();
      //expect(instance).to.be.a(CodaJsClient.RowValue);
    });
    ...
    it('should have the property tableUrl (base name: "tableUrl")', function() {
      // uncomment below and update the code to test the property tableUrl
      //var instane = new CodaJsClient.RowValue();
      //expect(instance).to.be();
    });
