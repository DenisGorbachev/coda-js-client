...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ApiLinkResolvedResource();
  });
  ...
  describe('ApiLinkResolvedResource', function() {
    it('should create an instance of ApiLinkResolvedResource', function() {
      // uncomment below and update the code to test ApiLinkResolvedResource
      //var instane = new CodaJsClient.ApiLinkResolvedResource();
      //expect(instance).to.be.a(CodaJsClient.ApiLinkResolvedResource);
    });
