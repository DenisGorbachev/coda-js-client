...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ColumnReference();
  });
  ...
  describe('ColumnReference', function() {
    it('should create an instance of ColumnReference', function() {
      // uncomment below and update the code to test ColumnReference
      //var instane = new CodaJsClient.ColumnReference();
      //expect(instance).to.be.a(CodaJsClient.ColumnReference);
    });
