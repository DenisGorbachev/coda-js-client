...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.EmailColumnFormat();
  });
  ...
  describe('EmailColumnFormat', function() {
    it('should create an instance of EmailColumnFormat', function() {
      // uncomment below and update the code to test EmailColumnFormat
      //var instane = new CodaJsClient.EmailColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.EmailColumnFormat);
    });
