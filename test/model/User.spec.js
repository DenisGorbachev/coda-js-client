...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.User();
  });
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instane = new CodaJsClient.User();
      //expect(instance).to.be.a(CodaJsClient.User);
    });
    ...
    it('should have the property scoped (base name: "scoped")', function() {
      // uncomment below and update the code to test the property scoped
      //var instane = new CodaJsClient.User();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pictureLink (base name: "pictureLink")', function() {
      // uncomment below and update the code to test the property pictureLink
      //var instane = new CodaJsClient.User();
      //expect(instance).to.be();
    });
