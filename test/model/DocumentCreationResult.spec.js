...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocumentCreationResult();
  });
  ...
  describe('DocumentCreationResult', function() {
    it('should create an instance of DocumentCreationResult', function() {
      // uncomment below and update the code to test DocumentCreationResult
      //var instane = new CodaJsClient.DocumentCreationResult();
      //expect(instance).to.be.a(CodaJsClient.DocumentCreationResult);
    });
    ...
    it('should have the property browserLink (base name: "browserLink")', function() {
      // uncomment below and update the code to test the property browserLink
      //var instane = new CodaJsClient.DocumentCreationResult();
      //expect(instance).to.be();
    });
    ...
    it('should have the property docSize (base name: "docSize")', function() {
      // uncomment below and update the code to test the property docSize
      //var instane = new CodaJsClient.DocumentCreationResult();
      //expect(instance).to.be();
    });

    it('should have the property sourceDoc (base name: "sourceDoc")', function() {
      // uncomment below and update the code to test the property sourceDoc
      //var instane = new CodaJsClient.DocumentCreationResult();
      //expect(instance).to.be();
    });
