...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.AllOfDocumentCreationResultSourceDoc();
  });
  ...
  describe('AllOfDocumentCreationResultSourceDoc', function() {
    it('should create an instance of AllOfDocumentCreationResultSourceDoc', function() {
      // uncomment below and update the code to test AllOfDocumentCreationResultSourceDoc
      //var instane = new CodaJsClient.AllOfDocumentCreationResultSourceDoc();
      //expect(instance).to.be.a(CodaJsClient.AllOfDocumentCreationResultSourceDoc);
    });
