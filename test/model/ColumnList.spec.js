...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ColumnList();
  });
  ...
  describe('ColumnList', function() {
    it('should create an instance of ColumnList', function() {
      // uncomment below and update the code to test ColumnList
      //var instane = new CodaJsClient.ColumnList();
      //expect(instance).to.be.a(CodaJsClient.ColumnList);
    });
