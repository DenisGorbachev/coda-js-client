...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PushButtonResult();
  });
  ...
  describe('PushButtonResult', function() {
    it('should create an instance of PushButtonResult', function() {
      // uncomment below and update the code to test PushButtonResult
      //var instane = new CodaJsClient.PushButtonResult();
      //expect(instance).to.be.a(CodaJsClient.PushButtonResult);
    });
