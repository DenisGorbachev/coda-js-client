...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.RowsUpsert();
  });
  ...
  describe('RowsUpsert', function() {
    it('should create an instance of RowsUpsert', function() {
      // uncomment below and update the code to test RowsUpsert
      //var instane = new CodaJsClient.RowsUpsert();
      //expect(instance).to.be.a(CodaJsClient.RowsUpsert);
    });
    ...
    it('should have the property keyColumns (base name: "keyColumns")', function() {
      // uncomment below and update the code to test the property keyColumns
      //var instane = new CodaJsClient.RowsUpsert();
      //expect(instance).to.be();
    });
