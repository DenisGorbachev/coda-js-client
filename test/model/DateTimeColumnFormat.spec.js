...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DateTimeColumnFormat();
  });
  ...
  describe('DateTimeColumnFormat', function() {
    it('should create an instance of DateTimeColumnFormat', function() {
      // uncomment below and update the code to test DateTimeColumnFormat
      //var instane = new CodaJsClient.DateTimeColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.DateTimeColumnFormat);
    });
