...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackSummary();
  });
  ...
  describe('PackSummary', function() {
    it('should create an instance of PackSummary', function() {
      // uncomment below and update the code to test PackSummary
      //var instane = new CodaJsClient.PackSummary();
      //expect(instance).to.be.a(CodaJsClient.PackSummary);
    });
