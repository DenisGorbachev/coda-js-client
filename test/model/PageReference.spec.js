...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PageReference();
  });
  ...
  describe('PageReference', function() {
    it('should create an instance of PageReference', function() {
      // uncomment below and update the code to test PageReference
      //var instane = new CodaJsClient.PageReference();
      //expect(instance).to.be.a(CodaJsClient.PageReference);
    });
