...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.AllOfDocSourceDoc();
  });
  ...
  describe('AllOfDocSourceDoc', function() {
    it('should create an instance of AllOfDocSourceDoc', function() {
      // uncomment below and update the code to test AllOfDocSourceDoc
      //var instane = new CodaJsClient.AllOfDocSourceDoc();
      //expect(instance).to.be.a(CodaJsClient.AllOfDocSourceDoc);
    });
