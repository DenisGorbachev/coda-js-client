...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ImageUrlValue();
  });
  ...
  describe('ImageUrlValue', function() {
    it('should create an instance of ImageUrlValue', function() {
      // uncomment below and update the code to test ImageUrlValue
      //var instane = new CodaJsClient.ImageUrlValue();
      //expect(instance).to.be.a(CodaJsClient.ImageUrlValue);
    });
