...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.AclMetadata();
  });
  ...
  describe('AclMetadata', function() {
    it('should create an instance of AclMetadata', function() {
      // uncomment below and update the code to test AclMetadata
      //var instane = new CodaJsClient.AclMetadata();
      //expect(instance).to.be.a(CodaJsClient.AclMetadata);
    });
    ...
    it('should have the property canShareWithOrg (base name: "canShareWithOrg")', function() {
      // uncomment below and update the code to test the property canShareWithOrg
      //var instane = new CodaJsClient.AclMetadata();
      //expect(instance).to.be();
    });
