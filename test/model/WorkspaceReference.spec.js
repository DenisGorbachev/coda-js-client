...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.WorkspaceReference();
  });
  ...
  describe('WorkspaceReference', function() {
    it('should create an instance of WorkspaceReference', function() {
      // uncomment below and update the code to test WorkspaceReference
      //var instane = new CodaJsClient.WorkspaceReference();
      //expect(instance).to.be.a(CodaJsClient.WorkspaceReference);
    });
