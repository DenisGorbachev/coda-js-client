...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.FormulaDetail();
  });
  ...
  describe('FormulaDetail', function() {
    it('should create an instance of FormulaDetail', function() {
      // uncomment below and update the code to test FormulaDetail
      //var instane = new CodaJsClient.FormulaDetail();
      //expect(instance).to.be.a(CodaJsClient.FormulaDetail);
    });
