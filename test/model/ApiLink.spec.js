...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ApiLink();
  });
  ...
  describe('ApiLink', function() {
    it('should create an instance of ApiLink', function() {
      // uncomment below and update the code to test ApiLink
      //var instane = new CodaJsClient.ApiLink();
      //expect(instance).to.be.a(CodaJsClient.ApiLink);
    });
