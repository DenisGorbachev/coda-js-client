...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackAssetUploadInfo();
  });
  ...
  describe('PackAssetUploadInfo', function() {
    it('should create an instance of PackAssetUploadInfo', function() {
      // uncomment below and update the code to test PackAssetUploadInfo
      //var instane = new CodaJsClient.PackAssetUploadInfo();
      //expect(instance).to.be.a(CodaJsClient.PackAssetUploadInfo);
    });
    ...
    it('should have the property packAssetUploadedPathName (base name: "packAssetUploadedPathName")', function() {
      // uncomment below and update the code to test the property packAssetUploadedPathName
      //var instane = new CodaJsClient.PackAssetUploadInfo();
      //expect(instance).to.be();
    });
