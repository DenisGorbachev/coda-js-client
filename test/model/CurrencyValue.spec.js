...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.CurrencyValue();
  });
  ...
  describe('CurrencyValue', function() {
    it('should create an instance of CurrencyValue', function() {
      // uncomment below and update the code to test CurrencyValue
      //var instane = new CodaJsClient.CurrencyValue();
      //expect(instance).to.be.a(CodaJsClient.CurrencyValue);
    });
