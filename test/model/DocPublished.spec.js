...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocPublished();
  });
  ...
  describe('DocPublished', function() {
    it('should create an instance of DocPublished', function() {
      // uncomment below and update the code to test DocPublished
      //var instane = new CodaJsClient.DocPublished();
      //expect(instance).to.be.a(CodaJsClient.DocPublished);
    });
    ...
    it('should have the property earnCredit (base name: "earnCredit")', function() {
      // uncomment below and update the code to test the property earnCredit
      //var instane = new CodaJsClient.DocPublished();
      //expect(instance).to.be();
    });
