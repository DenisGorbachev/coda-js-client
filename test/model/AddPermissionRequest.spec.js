...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.AddPermissionRequest();
  });
  ...
  describe('AddPermissionRequest', function() {
    it('should create an instance of AddPermissionRequest', function() {
      ...
      //var instane = new CodaJsClient.AddPermissionRequest();
      //expect(instance).to.be.a(CodaJsClient.AddPermissionRequest);
    });
    ...
    it('should have the property suppressEmail (base name: "suppressEmail")', function() {
      // uncomment below and update the code to test the property suppressEmail
      //var instane = new CodaJsClient.AddPermissionRequest();
      //expect(instance).to.be();
    });
