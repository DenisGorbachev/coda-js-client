...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.InlineResponse4001();
  });
  ...
  describe('InlineResponse4001', function() {
    it('should create an instance of InlineResponse4001', function() {
      ...
      //var instane = new CodaJsClient.InlineResponse4001();
      //expect(instance).to.be.a(CodaJsClient.InlineResponse4001);
    });
    ...
    it('should have the property codaDetail (base name: "codaDetail")', function() {
      // uncomment below and update the code to test the property codaDetail
      //var instane = new CodaJsClient.InlineResponse4001();
      //expect(instance).to.be();
    });
