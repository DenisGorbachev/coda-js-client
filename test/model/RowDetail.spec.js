...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.RowDetail();
  });
  ...
  describe('RowDetail', function() {
    it('should create an instance of RowDetail', function() {
      // uncomment below and update the code to test RowDetail
      //var instane = new CodaJsClient.RowDetail();
      //expect(instance).to.be.a(CodaJsClient.RowDetail);
    });
