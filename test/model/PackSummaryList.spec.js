...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackSummaryList();
  });
  ...
  describe('PackSummaryList', function() {
    it('should create an instance of PackSummaryList', function() {
      // uncomment below and update the code to test PackSummaryList
      //var instane = new CodaJsClient.PackSummaryList();
      //expect(instance).to.be.a(CodaJsClient.PackSummaryList);
    });
