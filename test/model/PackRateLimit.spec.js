...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackRateLimit();
  });
  ...
  describe('PackRateLimit', function() {
    it('should create an instance of PackRateLimit', function() {
      // uncomment below and update the code to test PackRateLimit
      //var instane = new CodaJsClient.PackRateLimit();
      //expect(instance).to.be.a(CodaJsClient.PackRateLimit);
    });
