...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.EmailPrincipal();
  });
  ...
  describe('EmailPrincipal', function() {
    it('should create an instance of EmailPrincipal', function() {
      // uncomment below and update the code to test EmailPrincipal
      //var instane = new CodaJsClient.EmailPrincipal();
      //expect(instance).to.be.a(CodaJsClient.EmailPrincipal);
    });
