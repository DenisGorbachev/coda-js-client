...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DomainPrincipal();
  });
  ...
  describe('DomainPrincipal', function() {
    it('should create an instance of DomainPrincipal', function() {
      // uncomment below and update the code to test DomainPrincipal
      //var instane = new CodaJsClient.DomainPrincipal();
      //expect(instance).to.be.a(CodaJsClient.DomainPrincipal);
    });
