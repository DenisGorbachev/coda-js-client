...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackAssetUploadCompleteResponse();
  });
  ...
  describe('PackAssetUploadCompleteResponse', function() {
    it('should create an instance of PackAssetUploadCompleteResponse', function() {
      // uncomment below and update the code to test PackAssetUploadCompleteResponse
      //var instane = new CodaJsClient.PackAssetUploadCompleteResponse();
      //expect(instance).to.be.a(CodaJsClient.PackAssetUploadCompleteResponse);
    });
    ...
    it('should have the property verifiedUploadUrl (base name: "verifiedUploadUrl")', function() {
      // uncomment below and update the code to test the property verifiedUploadUrl
      //var instane = new CodaJsClient.PackAssetUploadCompleteResponse();
      //expect(instance).to.be();
    });
