...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocList();
  });
  ...
  describe('DocList', function() {
    it('should create an instance of DocList', function() {
      // uncomment below and update the code to test DocList
      //var instane = new CodaJsClient.DocList();
      //expect(instance).to.be.a(CodaJsClient.DocList);
    });
