...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.LinkedDataObject();
  });
  ...
  describe('LinkedDataObject', function() {
    it('should create an instance of LinkedDataObject', function() {
      // uncomment below and update the code to test LinkedDataObject
      //var instane = new CodaJsClient.LinkedDataObject();
      //expect(instance).to.be.a(CodaJsClient.LinkedDataObject);
    });
