...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackPermission();
  });
  ...
  describe('PackPermission', function() {
    it('should create an instance of PackPermission', function() {
      // uncomment below and update the code to test PackPermission
      //var instane = new CodaJsClient.PackPermission();
      //expect(instance).to.be.a(CodaJsClient.PackPermission);
    });
