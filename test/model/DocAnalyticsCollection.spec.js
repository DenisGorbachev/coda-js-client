...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocAnalyticsCollection();
  });
  ...
  describe('DocAnalyticsCollection', function() {
    it('should create an instance of DocAnalyticsCollection', function() {
      // uncomment below and update the code to test DocAnalyticsCollection
      //var instane = new CodaJsClient.DocAnalyticsCollection();
      //expect(instance).to.be.a(CodaJsClient.DocAnalyticsCollection);
    });
