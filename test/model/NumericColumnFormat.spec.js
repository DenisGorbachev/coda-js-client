...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.NumericColumnFormat();
  });
  ...
  describe('NumericColumnFormat', function() {
    it('should create an instance of NumericColumnFormat', function() {
      // uncomment below and update the code to test NumericColumnFormat
      //var instane = new CodaJsClient.NumericColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.NumericColumnFormat);
    });
    ...
    it('should have the property useThousandsSeparator (base name: "useThousandsSeparator")', function() {
      // uncomment below and update the code to test the property useThousandsSeparator
      //var instane = new CodaJsClient.NumericColumnFormat();
      //expect(instance).to.be();
    });
