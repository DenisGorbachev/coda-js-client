...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PackUserPrincipal();
  });
  ...
  describe('PackUserPrincipal', function() {
    it('should create an instance of PackUserPrincipal', function() {
      // uncomment below and update the code to test PackUserPrincipal
      //var instane = new CodaJsClient.PackUserPrincipal();
      //expect(instance).to.be.a(CodaJsClient.PackUserPrincipal);
    });
