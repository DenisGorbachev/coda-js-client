...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.UpdatePackRequest();
  });
  ...
  describe('UpdatePackRequest', function() {
    it('should create an instance of UpdatePackRequest', function() {
      // uncomment below and update the code to test UpdatePackRequest
      //var instane = new CodaJsClient.UpdatePackRequest();
      //expect(instance).to.be.a(CodaJsClient.UpdatePackRequest);
    });

    it('should have the property overallRateLimit (base name: "overallRateLimit")', function() {
      // uncomment below and update the code to test the property overallRateLimit
      //var instane = new CodaJsClient.UpdatePackRequest();
      //expect(instance).to.be();
    });

    it('should have the property perConnectionRateLimit (base name: "perConnectionRateLimit")', function() {
      // uncomment below and update the code to test the property perConnectionRateLimit
      //var instane = new CodaJsClient.UpdatePackRequest();
      //expect(instance).to.be();
    });
