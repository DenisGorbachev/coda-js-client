...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ChangeRole();
  });
  ...
  describe('ChangeRole', function() {
    it('should create an instance of ChangeRole', function() {
      // uncomment below and update the code to test ChangeRole
      //var instane = new CodaJsClient.ChangeRole();
      //expect(instance).to.be.a(CodaJsClient.ChangeRole);
    });
    ...
    it('should have the property newRole (base name: "newRole")', function() {
      // uncomment below and update the code to test the property newRole
      //var instane = new CodaJsClient.ChangeRole();
      //expect(instance).to.be();
    });
