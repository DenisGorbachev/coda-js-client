...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.CurrencyColumnFormat();
  });
  ...
  describe('CurrencyColumnFormat', function() {
    it('should create an instance of CurrencyColumnFormat', function() {
      // uncomment below and update the code to test CurrencyColumnFormat
      //var instane = new CodaJsClient.CurrencyColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.CurrencyColumnFormat);
    });
