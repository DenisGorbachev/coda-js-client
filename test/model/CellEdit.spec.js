...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.CellEdit();
  });
  ...
  describe('CellEdit', function() {
    it('should create an instance of CellEdit', function() {
      // uncomment below and update the code to test CellEdit
      //var instane = new CodaJsClient.CellEdit();
      //expect(instance).to.be.a(CodaJsClient.CellEdit);
    });
