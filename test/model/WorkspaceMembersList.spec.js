...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.WorkspaceMembersList();
  });
  ...
  describe('WorkspaceMembersList', function() {
    it('should create an instance of WorkspaceMembersList', function() {
      // uncomment below and update the code to test WorkspaceMembersList
      //var instane = new CodaJsClient.WorkspaceMembersList();
      //expect(instance).to.be.a(CodaJsClient.WorkspaceMembersList);
    });
