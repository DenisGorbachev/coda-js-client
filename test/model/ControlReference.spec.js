...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ControlReference();
  });
  ...
  describe('ControlReference', function() {
    it('should create an instance of ControlReference', function() {
      // uncomment below and update the code to test ControlReference
      //var instane = new CodaJsClient.ControlReference();
      //expect(instance).to.be.a(CodaJsClient.ControlReference);
    });
