...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocAnalyticsItem();
  });
  ...
  describe('DocAnalyticsItem', function() {
    it('should create an instance of DocAnalyticsItem', function() {
      // uncomment below and update the code to test DocAnalyticsItem
      //var instane = new CodaJsClient.DocAnalyticsItem();
      //expect(instance).to.be.a(CodaJsClient.DocAnalyticsItem);
    });
    ...
    it('should have the property sessionsMobile (base name: "sessionsMobile")', function() {
      // uncomment below and update the code to test the property sessionsMobile
      //var instane = new CodaJsClient.DocAnalyticsItem();
      //expect(instance).to.be();
    });

    it('should have the property sessionsDesktop (base name: "sessionsDesktop")', function() {
      // uncomment below and update the code to test the property sessionsDesktop
      //var instane = new CodaJsClient.DocAnalyticsItem();
      //expect(instance).to.be();
    });

    it('should have the property sessionsOther (base name: "sessionsOther")', function() {
      // uncomment below and update the code to test the property sessionsOther
      //var instane = new CodaJsClient.DocAnalyticsItem();
      //expect(instance).to.be();
    });
