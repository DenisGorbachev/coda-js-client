...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ControlList();
  });
  ...
  describe('ControlList', function() {
    it('should create an instance of ControlList', function() {
      // uncomment below and update the code to test ControlList
      //var instane = new CodaJsClient.ControlList();
      //expect(instance).to.be.a(CodaJsClient.ControlList);
    });
