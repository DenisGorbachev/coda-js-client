...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.WorkspaceUser();
  });
  ...
  describe('WorkspaceUser', function() {
    it('should create an instance of WorkspaceUser', function() {
      // uncomment below and update the code to test WorkspaceUser
      //var instane = new CodaJsClient.WorkspaceUser();
      //expect(instance).to.be.a(CodaJsClient.WorkspaceUser);
    });
    ...
    it('should have the property roleChangedAt (base name: "roleChangedAt")', function() {
      // uncomment below and update the code to test the property roleChangedAt
      //var instane = new CodaJsClient.WorkspaceUser();
      //expect(instance).to.be();
    });
    ...
    it('should have the property docsLastActiveAt (base name: "docsLastActiveAt")', function() {
      // uncomment below and update the code to test the property docsLastActiveAt
      //var instane = new CodaJsClient.WorkspaceUser();
      //expect(instance).to.be();
    });

    it('should have the property ownedDocIds (base name: "ownedDocIds")', function() {
      // uncomment below and update the code to test the property ownedDocIds
      //var instane = new CodaJsClient.WorkspaceUser();
      //expect(instance).to.be();
    });

    it('should have the property docCollaboratorCount (base name: "docCollaboratorCount")', function() {
      // uncomment below and update the code to test the property docCollaboratorCount
      //var instane = new CodaJsClient.WorkspaceUser();
      //expect(instance).to.be();
    });
