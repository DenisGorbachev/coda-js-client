...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DurationColumnFormat();
  });
  ...
  describe('DurationColumnFormat', function() {
    it('should create an instance of DurationColumnFormat', function() {
      // uncomment below and update the code to test DurationColumnFormat
      //var instane = new CodaJsClient.DurationColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.DurationColumnFormat);
    });
    ...
    it('should have the property maxUnit (base name: "maxUnit")', function() {
      // uncomment below and update the code to test the property maxUnit
      //var instane = new CodaJsClient.DurationColumnFormat();
      //expect(instance).to.be();
    });
