...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocSize();
  });
  ...
  describe('DocSize', function() {
    it('should create an instance of DocSize', function() {
      // uncomment below and update the code to test DocSize
      //var instane = new CodaJsClient.DocSize();
      //expect(instance).to.be.a(CodaJsClient.DocSize);
    });
    ...
    it('should have the property tableAndViewCount (base name: "tableAndViewCount")', function() {
      // uncomment below and update the code to test the property tableAndViewCount
      //var instane = new CodaJsClient.DocSize();
      //expect(instance).to.be();
    });
    ...
    it('should have the property overApiSizeLimit (base name: "overApiSizeLimit")', function() {
      // uncomment below and update the code to test the property overApiSizeLimit
      //var instane = new CodaJsClient.DocSize();
      //expect(instance).to.be();
    });
