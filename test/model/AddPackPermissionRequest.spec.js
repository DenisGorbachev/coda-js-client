...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.AddPackPermissionRequest();
  });
  ...
  describe('AddPackPermissionRequest', function() {
    it('should create an instance of AddPackPermissionRequest', function() {
      // uncomment below and update the code to test AddPackPermissionRequest
      //var instane = new CodaJsClient.AddPackPermissionRequest();
      //expect(instance).to.be.a(CodaJsClient.AddPackPermissionRequest);
    });
