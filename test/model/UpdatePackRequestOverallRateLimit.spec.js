...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.UpdatePackRequestOverallRateLimit();
  });
  ...
  describe('UpdatePackRequestOverallRateLimit', function() {
    it('should create an instance of UpdatePackRequestOverallRateLimit', function() {
      // uncomment below and update the code to test UpdatePackRequestOverallRateLimit
      //var instane = new CodaJsClient.UpdatePackRequestOverallRateLimit();
      //expect(instance).to.be.a(CodaJsClient.UpdatePackRequestOverallRateLimit);
    });
    ...
    it('should have the property operationsPerInterval (base name: "operationsPerInterval")', function() {
      // uncomment below and update the code to test the property operationsPerInterval
      //var instane = new CodaJsClient.UpdatePackRequestOverallRateLimit();
      //expect(instance).to.be();
    });
