...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocCreate();
  });
  ...
  describe('DocCreate', function() {
    it('should create an instance of DocCreate', function() {
      // uncomment below and update the code to test DocCreate
      //var instane = new CodaJsClient.DocCreate();
      //expect(instance).to.be.a(CodaJsClient.DocCreate);
    });
