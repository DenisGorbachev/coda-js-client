...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.SimpleColumnFormat();
  });
  ...
  describe('SimpleColumnFormat', function() {
    it('should create an instance of SimpleColumnFormat', function() {
      // uncomment below and update the code to test SimpleColumnFormat
      //var instane = new CodaJsClient.SimpleColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.SimpleColumnFormat);
    });
