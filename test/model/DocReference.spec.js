...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocReference();
  });
  ...
  describe('DocReference', function() {
    it('should create an instance of DocReference', function() {
      // uncomment below and update the code to test DocReference
      //var instane = new CodaJsClient.DocReference();
      //expect(instance).to.be.a(CodaJsClient.DocReference);
    });
