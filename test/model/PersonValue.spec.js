...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PersonValue();
  });
  ...
  describe('PersonValue', function() {
    it('should create an instance of PersonValue', function() {
      // uncomment below and update the code to test PersonValue
      //var instane = new CodaJsClient.PersonValue();
      //expect(instance).to.be.a(CodaJsClient.PersonValue);
    });
