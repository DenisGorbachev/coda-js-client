...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ColumnDetail();
  });
  ...
  describe('ColumnDetail', function() {
    it('should create an instance of ColumnDetail', function() {
      // uncomment below and update the code to test ColumnDetail
      //var instane = new CodaJsClient.ColumnDetail();
      //expect(instance).to.be.a(CodaJsClient.ColumnDetail);
    });
