...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.UrlValue();
  });
  ...
  describe('UrlValue', function() {
    it('should create an instance of UrlValue', function() {
      // uncomment below and update the code to test UrlValue
      //var instane = new CodaJsClient.UrlValue();
      //expect(instance).to.be.a(CodaJsClient.UrlValue);
    });
