...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.AllOfTableFilter();
  });
  ...
  describe('AllOfTableFilter', function() {
    it('should create an instance of AllOfTableFilter', function() {
      // uncomment below and update the code to test AllOfTableFilter
      //var instane = new CodaJsClient.AllOfTableFilter();
      //expect(instance).to.be.a(CodaJsClient.AllOfTableFilter);
    });
    ...
    it('should have the property isVolatile (base name: "isVolatile")', function() {
      // uncomment below and update the code to test the property isVolatile
      //var instane = new CodaJsClient.AllOfTableFilter();
      //expect(instance).to.be();
    });

    it('should have the property hasUserFormula (base name: "hasUserFormula")', function() {
      // uncomment below and update the code to test the property hasUserFormula
      //var instane = new CodaJsClient.AllOfTableFilter();
      //expect(instance).to.be();
    });

    it('should have the property hasTodayFormula (base name: "hasTodayFormula")', function() {
      // uncomment below and update the code to test the property hasTodayFormula
      //var instane = new CodaJsClient.AllOfTableFilter();
      //expect(instance).to.be();
    });

    it('should have the property hasNowFormula (base name: "hasNowFormula")', function() {
      // uncomment below and update the code to test the property hasNowFormula
      //var instane = new CodaJsClient.AllOfTableFilter();
      //expect(instance).to.be();
    });
