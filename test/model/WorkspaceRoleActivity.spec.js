...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.WorkspaceRoleActivity();
  });
  ...
  describe('WorkspaceRoleActivity', function() {
    it('should create an instance of WorkspaceRoleActivity', function() {
      // uncomment below and update the code to test WorkspaceRoleActivity
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be.a(CodaJsClient.WorkspaceRoleActivity);
    });
    ...
    it('should have the property activeAdminCount (base name: "activeAdminCount")', function() {
      // uncomment below and update the code to test the property activeAdminCount
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be();
    });

    it('should have the property activeDocMakerCount (base name: "activeDocMakerCount")', function() {
      // uncomment below and update the code to test the property activeDocMakerCount
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be();
    });

    it('should have the property activeEditorCount (base name: "activeEditorCount")', function() {
      // uncomment below and update the code to test the property activeEditorCount
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be();
    });

    it('should have the property inactiveAdminCount (base name: "inactiveAdminCount")', function() {
      // uncomment below and update the code to test the property inactiveAdminCount
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be();
    });

    it('should have the property inactiveDocMakerCount (base name: "inactiveDocMakerCount")', function() {
      // uncomment below and update the code to test the property inactiveDocMakerCount
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be();
    });

    it('should have the property inactiveEditorCount (base name: "inactiveEditorCount")', function() {
      // uncomment below and update the code to test the property inactiveEditorCount
      //var instane = new CodaJsClient.WorkspaceRoleActivity();
      //expect(instance).to.be();
    });
