...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ScaleColumnFormat();
  });
  ...
  describe('ScaleColumnFormat', function() {
    it('should create an instance of ScaleColumnFormat', function() {
      // uncomment below and update the code to test ScaleColumnFormat
      //var instane = new CodaJsClient.ScaleColumnFormat();
      //expect(instance).to.be.a(CodaJsClient.ScaleColumnFormat);
    });
