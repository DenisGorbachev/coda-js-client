...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.Table();
  });
  ...
  describe('Table', function() {
    it('should create an instance of Table', function() {
      ...
      //var instane = new CodaJsClient.Table();
      //expect(instance).to.be.a(CodaJsClient.Table);
    });
    ...
    it('should have the property parentTable (base name: "parentTable")', function() {
      // uncomment below and update the code to test the property parentTable
      //var instane = new CodaJsClient.Table();
      //expect(instance).to.be();
    });

    it('should have the property displayColumn (base name: "displayColumn")', function() {
      // uncomment below and update the code to test the property displayColumn
      //var instane = new CodaJsClient.Table();
      //expect(instance).to.be();
    });
