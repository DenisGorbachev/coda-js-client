...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.RowsApi();
  });
  ...
  describe('RowsApi', function() {
    describe('deleteRow', function() {
      it('should call deleteRow successfully', function(done) {
        //uncomment below and update the code to test deleteRow
        //instance.deleteRow(function(error) {
    ...
    describe('deleteRows', function() {
      it('should call deleteRows successfully', function(done) {
        //uncomment below and update the code to test deleteRows
        //instance.deleteRows(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRow', function() {
      it('should call getRow successfully', function(done) {
        //uncomment below and update the code to test getRow
        //instance.getRow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listRows', function() {
      it('should call listRows successfully', function(done) {
        //uncomment below and update the code to test listRows
        //instance.listRows(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pushButton', function() {
      it('should call pushButton successfully', function(done) {
        //uncomment below and update the code to test pushButton
        //instance.pushButton(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateRow', function() {
      it('should call updateRow successfully', function(done) {
        //uncomment below and update the code to test updateRow
        //instance.updateRow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upsertRows', function() {
      it('should call upsertRows successfully', function(done) {
        //uncomment below and update the code to test upsertRows
        //instance.upsertRows(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
