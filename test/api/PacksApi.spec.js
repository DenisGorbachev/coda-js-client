...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.CodaJsClient);
  }
}(this, function(expect, CodaJsClient) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new CodaJsClient.PacksApi();
  });
  ...
  describe('PacksApi', function() {
    describe('addPackPermission', function() {
      it('should call addPackPermission successfully', function(done) {
        //uncomment below and update the code to test addPackPermission
        //instance.addPackPermission(function(error) {
    ...
    describe('deletePackPermission', function() {
      it('should call deletePackPermission successfully', function(done) {
        //uncomment below and update the code to test deletePackPermission
        //instance.deletePackPermission(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPack', function() {
      it('should call getPack successfully', function(done) {
        //uncomment below and update the code to test getPack
        //instance.getPack(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPackPermissions', function() {
      it('should call getPackPermissions successfully', function(done) {
        //uncomment below and update the code to test getPackPermissions
        //instance.getPackPermissions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('packAssetUploadComplete', function() {
      it('should call packAssetUploadComplete successfully', function(done) {
        //uncomment below and update the code to test packAssetUploadComplete
        //instance.packAssetUploadComplete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('packVersionUploadComplete', function() {
      it('should call packVersionUploadComplete successfully', function(done) {
        //uncomment below and update the code to test packVersionUploadComplete
        //instance.packVersionUploadComplete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('registerPackVersion', function() {
      it('should call registerPackVersion successfully', function(done) {
        //uncomment below and update the code to test registerPackVersion
        //instance.registerPackVersion(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('setPackLiveVersion', function() {
      it('should call setPackLiveVersion successfully', function(done) {
        //uncomment below and update the code to test setPackLiveVersion
        //instance.setPackLiveVersion(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadPackAsset', function() {
      it('should call uploadPackAsset successfully', function(done) {
        //uncomment below and update the code to test uploadPackAsset
        //instance.uploadPackAsset(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
