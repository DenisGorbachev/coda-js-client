...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PermissionsApi();
  });
  ...
  describe('PermissionsApi', function() {
    describe('addPermission', function() {
      it('should call addPermission successfully', function(done) {
        //uncomment below and update the code to test addPermission
        //instance.addPermission(function(error) {
    ...
    describe('getSharingMetadata', function() {
      it('should call getSharingMetadata successfully', function(done) {
        //uncomment below and update the code to test getSharingMetadata
        //instance.getSharingMetadata(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
