...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.WorkspacesApi();
  });
  ...
  describe('WorkspacesApi', function() {
    describe('changeUserRole', function() {
      it('should call changeUserRole successfully', function(done) {
        //uncomment below and update the code to test changeUserRole
        //instance.changeUserRole(function(error) {
    ...
    describe('listWorkspaceMembers', function() {
      it('should call listWorkspaceMembers successfully', function(done) {
        //uncomment below and update the code to test listWorkspaceMembers
        //instance.listWorkspaceMembers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listWorkspaceRoleActivity', function() {
      it('should call listWorkspaceRoleActivity successfully', function(done) {
        //uncomment below and update the code to test listWorkspaceRoleActivity
        //instance.listWorkspaceRoleActivity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
