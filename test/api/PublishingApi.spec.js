...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.PublishingApi();
  });
  ...
  describe('PublishingApi', function() {
    ...
    describe('publishDoc', function() {
      it('should call publishDoc successfully', function(done) {
        //uncomment below and update the code to test publishDoc
        //instance.publishDoc(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('unpublishDoc', function() {
      it('should call unpublishDoc successfully', function(done) {
        //uncomment below and update the code to test unpublishDoc
        //instance.unpublishDoc(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
