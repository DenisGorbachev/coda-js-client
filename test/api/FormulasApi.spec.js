...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.FormulasApi();
  });
  ...
  describe('FormulasApi', function() {
    describe('getFormula', function() {
      it('should call getFormula successfully', function(done) {
        //uncomment below and update the code to test getFormula
        //instance.getFormula(function(error) {
    ...
    describe('listFormulas', function() {
      it('should call listFormulas successfully', function(done) {
        //uncomment below and update the code to test listFormulas
        //instance.listFormulas(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
