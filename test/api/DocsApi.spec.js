...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.DocsApi();
  });
  ...
  describe('DocsApi', function() {
    ...
    describe('listDocs', function() {
      it('should call listDocs successfully', function(done) {
        //uncomment below and update the code to test listDocs
        //instance.listDocs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
