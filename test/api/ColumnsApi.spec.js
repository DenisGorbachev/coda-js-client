...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.ColumnsApi();
  });
  ...
  describe('ColumnsApi', function() {
    describe('getColumn', function() {
      it('should call getColumn successfully', function(done) {
        //uncomment below and update the code to test getColumn
        //instance.getColumn(function(error) {
    ...
    describe('listColumns', function() {
      it('should call listColumns successfully', function(done) {
        //uncomment below and update the code to test listColumns
        //instance.listColumns(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
