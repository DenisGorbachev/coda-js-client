...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodaJsClient.MiscellaneousApi();
  });
  ...
  describe('MiscellaneousApi', function() {
    describe('getMutationStatus', function() {
      it('should call getMutationStatus successfully', function(done) {
        //uncomment below and update the code to test getMutationStatus
        //instance.getMutationStatus(function(error) {
    ...
    describe('resolveBrowserLink', function() {
      it('should call resolveBrowserLink successfully', function(done) {
        //uncomment below and update the code to test resolveBrowserLink
        //instance.resolveBrowserLink(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
