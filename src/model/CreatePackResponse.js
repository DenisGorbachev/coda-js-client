...
/**
* The CreatePackResponse model module.
* @module model/CreatePackResponse
* @version 1.2.0
*/
export default class CreatePackResponse {
    /**
    * Constructs a new <code>CreatePackResponse</code>.
    * Info about a Pack that was just created.
    * @alias module:model/CreatePackResponse
    * @class
    * @param packId {Number} The ID assigned to the newly-created Pack.
    */
    ...
    /**
    * Constructs a <code>CreatePackResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreatePackResponse} obj Optional instance to populate.
    * @return {module:model/CreatePackResponse} The populated <code>CreatePackResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePackResponse();
    ...
    */
    ...
    /**
    * Returns The ID assigned to the newly-created Pack.
    * @return {Number}
    */
    getPackId() {
        return this.packId;
    ...
    /**
    * Sets The ID assigned to the newly-created Pack.
    * @param {Number} packId The ID assigned to the newly-created Pack.
    */
    setPackId(packId) {
        this['packId'] = packId;
    }
