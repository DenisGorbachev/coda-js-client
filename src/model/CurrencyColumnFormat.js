...
import CurrencyFormatType from './CurrencyFormatType';
import SimpleColumnFormat from './SimpleColumnFormat';

/**
* The CurrencyColumnFormat model module.
* @module model/CurrencyColumnFormat
* @version 1.2.0
*/
export default class CurrencyColumnFormat {
    /**
    * Constructs a new <code>CurrencyColumnFormat</code>.
    * Format of a currency column.
    * @alias module:model/CurrencyColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>CurrencyColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CurrencyColumnFormat} obj Optional instance to populate.
    * @return {module:model/CurrencyColumnFormat} The populated <code>CurrencyColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyColumnFormat();
            ...
            if (data.hasOwnProperty('format')) {
                obj['format'] = CurrencyFormatType.constructFromObject(data['format']);
            }
        }
        return obj;
    }
    ...
    */
    'precision' = undefined;
    /**
    * @member {module:model/CurrencyFormatType} format
    */
    'format' = undefined;
    ...
    * @param {String} currencyCode The currency symbol
    */
    ...
    */
    ...
    /**
    * @return {module:model/CurrencyFormatType}
    */
    getFormat() {
        return this.format;
    }
    ...
    /**
    * @param {module:model/CurrencyFormatType} format
    */
    setFormat(format) {
        this['format'] = format;
    }
