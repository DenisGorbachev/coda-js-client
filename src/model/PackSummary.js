...
/**
* The PackSummary model module.
* @module model/PackSummary
* @version 1.2.0
*/
export default class PackSummary {
    /**
    * Constructs a new <code>PackSummary</code>.
    * Summary of a Pack.
    * @alias module:model/PackSummary
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>PackSummary</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackSummary} obj Optional instance to populate.
    * @return {module:model/PackSummary} The populated <code>PackSummary</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackSummary();
