...
/**
* The RowUpdate model module.
* @module model/RowUpdate
* @version 1.2.0
*/
export default class RowUpdate {
    /**
    * Constructs a new <code>RowUpdate</code>.
    * Payload for updating a row in a table.
    * @alias module:model/RowUpdate
    * @class
    * @param row {module:model/RowEdit} 
    */
    ...
    /**
    * Constructs a <code>RowUpdate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowUpdate} obj Optional instance to populate.
    * @return {module:model/RowUpdate} The populated <code>RowUpdate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowUpdate();
                        
            
            if (data.hasOwnProperty('row')) {
                obj['row'] = RowEdit.constructFromObject(data['row']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/RowEdit} row
    */
    'row' = undefined;


    /**
    * @return {module:model/RowEdit}
    */
    getRow() {
        return this.row;
    }
    ...
    /**
    * @param {module:model/RowEdit} row
    */
    setRow(row) {
        this['row'] = row;
    }
