...
/**
* The FormulaReference model module.
* @module model/FormulaReference
* @version 1.2.0
*/
export default class FormulaReference {
    /**
    * Constructs a new <code>FormulaReference</code>.
    * Reference to a formula.
    * @alias module:model/FormulaReference
    * @class
    * @param id {String} ID of the formula.
    * @param type {module:model/FormulaReference.TypeEnum} The type of this resource.
    * @param href {String} API link to the formula.
    * @param name {String} Name of the formula.
    */

    constructor(id, type, href, name) {
    ...
    /**
    * Constructs a <code>FormulaReference</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FormulaReference} obj Optional instance to populate.
    * @return {module:model/FormulaReference} The populated <code>FormulaReference</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormulaReference();
    ...
    * @member {module:model/FormulaReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    */
    ...
    /**
    * Sets ID of the formula.
    * @param {String} id ID of the formula.
    */
    setId(id) {
        this['id'] = id;
    }
    ...
    * @return {module:model/FormulaReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/FormulaReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns API link to the formula.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the formula.
    * @param {String} href API link to the formula.
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * Returns Name of the formula.
    * @return {String}
    */
    getName() {
        return this.name;
