...
/**
* The AddPackPermissionResponse model module.
* @module model/AddPackPermissionResponse
* @version 1.2.0
*/
export default class AddPackPermissionResponse {
    /**
    * Constructs a new <code>AddPackPermissionResponse</code>.
    * Confirmation of successfully upserting a Pack permission.
    * @alias module:model/AddPackPermissionResponse
    * @class
    * @param permissionId {String} The ID of the permission created or updated.
    */
    ...
    /**
    * Constructs a <code>AddPackPermissionResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AddPackPermissionResponse} obj Optional instance to populate.
    * @return {module:model/AddPackPermissionResponse} The populated <code>AddPackPermissionResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddPackPermissionResponse();
    ...
    */
    ...
    /**
    * Returns The ID of the permission created or updated.
    * @return {String}
    */
    getPermissionId() {
    ...
    /**
    * Sets The ID of the permission created or updated.
    * @param {String} permissionId The ID of the permission created or updated.
    */
