...
/**
* The CellEdit model module.
* @module model/CellEdit
* @version 1.2.0
*/
export default class CellEdit {
    /**
    * Constructs a new <code>CellEdit</code>.
    * An edit made to a particular cell in a row.
    * @alias module:model/CellEdit
    * @class
    * @param column {String} Column ID, URL, or name (fragile and discouraged) associated with this edit.
    ...
    */
    ...
    /**
    * Constructs a <code>CellEdit</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CellEdit} obj Optional instance to populate.
    * @return {module:model/CellEdit} The populated <code>CellEdit</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CellEdit();
    ...
    */
    ...
    /**
    * Returns Column ID, URL, or name (fragile and discouraged) associated with this edit.
    * @return {String}
    */
    getColumn() {
        return this.column;
    ...
    /**
    * Sets Column ID, URL, or name (fragile and discouraged) associated with this edit.
    * @param {String} column Column ID, URL, or name (fragile and discouraged) associated with this edit.
    */
    setColumn(column) {
        this['column'] = column;
    }
