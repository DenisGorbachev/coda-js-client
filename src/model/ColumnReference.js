...
* @module model/ColumnReference
* @version 1.2.0
*/
export default class ColumnReference {
    /**
    * Constructs a new <code>ColumnReference</code>.
    * Reference to a column.
    * @alias module:model/ColumnReference
    * @class
    * @param id {String} ID of the column.
    * @param type {module:model/ColumnReference.TypeEnum} The type of this resource.
    * @param href {String} API link to the column.
    */

    constructor(id, type, href) {
    ...
    * @param {module:model/ColumnReference} obj Optional instance to populate.
    * @return {module:model/ColumnReference} The populated <code>ColumnReference</code> instance.
    */
    ...
    * @member {module:model/ColumnReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/ColumnReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/ColumnReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
