...
/**
* The AllOfDocAnalyticsItemDoc model module.
* @module model/AllOfDocAnalyticsItemDoc
* @version 1.2.0
*/
export default class AllOfDocAnalyticsItemDoc {
    /**
    * Constructs a new <code>AllOfDocAnalyticsItemDoc</code>.
    * @alias module:model/AllOfDocAnalyticsItemDoc
    * @class
    * @extends module:model/DocReference
    ...
    */
    ...
    constructor(id, type, href, browserLink, title) {
        DocReference.call(this, id, type, href, browserLink);
    ...
    /**
    * Constructs a <code>AllOfDocAnalyticsItemDoc</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfDocAnalyticsItemDoc} obj Optional instance to populate.
    * @return {module:model/AllOfDocAnalyticsItemDoc} The populated <code>AllOfDocAnalyticsItemDoc</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfDocAnalyticsItemDoc();
            
            DocReference.constructFromObject(data, obj);
