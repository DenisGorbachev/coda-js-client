...
/**
* The AddPackPermissionRequest model module.
* @module model/AddPackPermissionRequest
* @version 1.2.0
*/
export default class AddPackPermissionRequest {
    /**
    * Constructs a new <code>AddPackPermissionRequest</code>.
    * Payload for upserting a Pack permission.
    * @alias module:model/AddPackPermissionRequest
    * @class
    * @param principal {module:model/PackPrincipal} 
    * @param access {module:model/PackAccessType} 
    */

    constructor(principal, access) {
    ...
    /**
    * Constructs a <code>AddPackPermissionRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AddPackPermissionRequest} obj Optional instance to populate.
    * @return {module:model/AddPackPermissionRequest} The populated <code>AddPackPermissionRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddPackPermissionRequest();
