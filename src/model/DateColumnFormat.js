...
/**
* The DateColumnFormat model module.
* @module model/DateColumnFormat
* @version 1.2.0
*/
export default class DateColumnFormat {
    /**
    * Constructs a new <code>DateColumnFormat</code>.
    * Format of a date column.
    * @alias module:model/DateColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>DateColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DateColumnFormat} obj Optional instance to populate.
    * @return {module:model/DateColumnFormat} The populated <code>DateColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateColumnFormat();
    ...
    * @param {String} format A format string using Moment syntax: https://momentjs.com/docs/#/displaying/
    */
    setFormat(format) {
        this['format'] = format;
    }
