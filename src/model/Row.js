...
export default class Row {
    ...
    * @param type {module:model/Row.TypeEnum} The type of this resource.
    ...
    */
    ...
    constructor(id, type, href, name, index, browserLink, createdAt, updatedAt, values) {
    ...
    * @member {module:model/Row.TypeEnum} type
    */
    'type' = undefined;
    /**
    * API link to the row.
    ...
    * @return {module:model/Row.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/Row.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
