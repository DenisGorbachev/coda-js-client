...
import PackPermission from './PackPermission';

/**
* The PackPermissionList model module.
* @module model/PackPermissionList
* @version 1.2.0
*/
export default class PackPermissionList {
    /**
    * Constructs a new <code>PackPermissionList</code>.
    * List of Pack permissions.
    * @alias module:model/PackPermissionList
    * @class
    * @param items {Array.<module:model/PackPermission>} 
    */
    ...
    /**
    * Constructs a <code>PackPermissionList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackPermissionList} obj Optional instance to populate.
    * @return {module:model/PackPermissionList} The populated <code>PackPermissionList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackPermissionList();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [PackPermission]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/PackPermission>} items
    */
    'items' = undefined;


    /**
    * @return {Array.<module:model/PackPermission>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/PackPermission>} items
    */
    setItems(items) {
        this['items'] = items;
    }
