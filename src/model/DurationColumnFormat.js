...
/**
* The DurationColumnFormat model module.
* @module model/DurationColumnFormat
* @version 1.2.0
*/
export default class DurationColumnFormat {
    /**
    * Constructs a new <code>DurationColumnFormat</code>.
    * Format of a duration column.
    * @alias module:model/DurationColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>DurationColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DurationColumnFormat} obj Optional instance to populate.
    * @return {module:model/DurationColumnFormat} The populated <code>DurationColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DurationColumnFormat();
            ...
            if (data.hasOwnProperty('maxUnit')) {
                obj['maxUnit'] = ApiClient.convertToType(data['maxUnit'], ModelObject);
            }
        }
        return obj;
    }
    ...
    */
    'precision' = undefined;
    /**
    * @member {module:model/ModelObject} maxUnit
    */
    'maxUnit' = undefined;
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} maxUnit
    */
    setMaxUnit(maxUnit) {
