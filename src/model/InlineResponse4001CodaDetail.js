...
/**
* The InlineResponse4001CodaDetail model module.
* @module model/InlineResponse4001CodaDetail
* @version 1.2.0
*/
export default class InlineResponse4001CodaDetail {
    /**
    * Constructs a new <code>InlineResponse4001CodaDetail</code>.
    * Detail about why this request was rejected.
    * @alias module:model/InlineResponse4001CodaDetail
    * @class
    */
    ...
    /**
    * Constructs a <code>InlineResponse4001CodaDetail</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/InlineResponse4001CodaDetail} obj Optional instance to populate.
    * @return {module:model/InlineResponse4001CodaDetail} The populated <code>InlineResponse4001CodaDetail</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse4001CodaDetail();
    ...
    */
    ...
    /**
    * @return {Array.<module:model/ValidationError>}
    */
    getValidationErrors() {
    ...
    /**
    * @param {Array.<module:model/ValidationError>} validationErrors
    */
