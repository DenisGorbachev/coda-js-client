...
/**
* The ChangeRole model module.
* @module model/ChangeRole
* @version 1.2.0
*/
export default class ChangeRole {
    /**
    * Constructs a new <code>ChangeRole</code>.
    * Parameters for changing a workspace user role.
    * @alias module:model/ChangeRole
    * @class
    * @param email {String} Email of the user.
    * @param newRole {module:model/WorkspaceUserRole} 
    */

    constructor(email, newRole) {
    ...
    /**
    * Constructs a <code>ChangeRole</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ChangeRole} obj Optional instance to populate.
    * @return {module:model/ChangeRole} The populated <code>ChangeRole</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeRole();
            ...
            if (data.hasOwnProperty('newRole')) {
                obj['newRole'] = WorkspaceUserRole.constructFromObject(data['newRole']);
            }
        }
        return obj;
    }
    ...
    */
    'email' = undefined;
    /**
    * @member {module:model/WorkspaceUserRole} newRole
    */
    'newRole' = undefined;
    ...
    */
    ...
    /**
    * @param {module:model/WorkspaceUserRole} newRole
    */
    setNewRole(newRole) {
        this['newRole'] = newRole;
    }
