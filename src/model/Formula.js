...
export default class Formula {
    ...
    * @member {module:model/Formula.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/Formula.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/Formula.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
