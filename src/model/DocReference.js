...
/**
* The DocReference model module.
* @module model/DocReference
* @version 1.2.0
*/
export default class DocReference {
    /**
    * Constructs a new <code>DocReference</code>.
    * Reference to a Coda doc.
    * @alias module:model/DocReference
    * @class
    * @param id {String} ID of the Coda doc.
    * @param type {module:model/DocReference.TypeEnum} The type of this resource.
    ...
    */
    ...
    /**
    * Constructs a <code>DocReference</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocReference} obj Optional instance to populate.
    * @return {module:model/DocReference} The populated <code>DocReference</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocReference();
    ...
    * @member {module:model/DocReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/DocReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/DocReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
