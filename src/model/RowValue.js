...
import LinkedDataType from './LinkedDataType';

/**
* The RowValue model module.
* @module model/RowValue
* @version 1.2.0
*/
export default class RowValue {
    ...
    * @alias module:model/RowValue
    * @class
    * @extends module:model/LinkedDataObject
    * @param context {} A url describing the schema context for this object, typically \"http://schema.org/\".
    * @param type {} 
    * @param additionalType {} The type of this resource.
    * @param name {} The display name of the row, based on its identifying column.
    * @param url {} The url of the row.
    * @param tableId {} The ID of the table
    * @param rowId {} The ID of the table
    * @param tableUrl {} The url of the table.
    */

    constructor(context, type, additionalType, name, url, tableId, rowId, tableUrl) {
        LinkedDataObject.call(this, context, type);
        OneOfRichSingleValue.call(this);
        this['name'] = name;
        this['url'] = url;
    ...
    * @param {module:model/RowValue} obj Optional instance to populate.
    * @return {module:model/RowValue} The populated <code>RowValue</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowValue();
            
            LinkedDataObject.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('tableUrl')) {
                obj['tableUrl'] = ApiClient.convertToType(data['tableUrl'], 'String');
            }
    ...
    * @member {String} tableUrl
    */
    'tableUrl' = undefined;
    /**
    * The type of this resource.
    * @member {module:model/RowValue.AdditionalTypeEnum} additionalType
    */
    'additionalType' = undefined;

    // Implement OneOfRichSingleValue interface:
    ...
    */
    ...
    /**
    * Sets The ID of the table
    * @param {String} rowId The ID of the table
    */
    setRowId(rowId) {
        this['rowId'] = rowId;
    }
    /**
    * Returns The url of the table.
    * @return {String}
    */
    getTableUrl() {
    ...
    /**
    * Sets The url of the table.
    * @param {String} tableUrl The url of the table.
    */
    ...
    * @return {module:model/RowValue.AdditionalTypeEnum}
    */
    getAdditionalType() {
    ...
    * @param {module:model/RowValue.AdditionalTypeEnum} additionalType The type of this resource.
    */
    ...
    /**
    * Allowed values for the <code>additionalType</code> property.
    * @enum {String}
    * @readonly
    */
    static AdditionalTypeEnum = {
        /**
         * value: "row"
         * @const
         */
