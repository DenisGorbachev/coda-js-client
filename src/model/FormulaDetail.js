...
/**
* The FormulaDetail model module.
* @module model/FormulaDetail
* @version 1.2.0
*/
export default class FormulaDetail {
    /**
    * Constructs a new <code>FormulaDetail</code>.
    * Detailed information about a formula.
    * @alias module:model/FormulaDetail
    * @class
    * @param valid {Boolean} Returns whether or not the given formula is valid.
    */
    ...
    /**
    * Constructs a <code>FormulaDetail</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FormulaDetail} obj Optional instance to populate.
    * @return {module:model/FormulaDetail} The populated <code>FormulaDetail</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormulaDetail();
