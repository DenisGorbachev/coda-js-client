...
/**
* The SetPackLiveVersionRequest model module.
* @module model/SetPackLiveVersionRequest
* @version 1.2.0
*/
export default class SetPackLiveVersionRequest {
    /**
    * Constructs a new <code>SetPackLiveVersionRequest</code>.
    * Payload for setting a Pack version live.
    * @alias module:model/SetPackLiveVersionRequest
    * @class
    * @param packVersion {String} The version of the Pack.
    */

    constructor(packVersion) {
    ...
    /**
    * Constructs a <code>SetPackLiveVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SetPackLiveVersionRequest} obj Optional instance to populate.
    * @return {module:model/SetPackLiveVersionRequest} The populated <code>SetPackLiveVersionRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetPackLiveVersionRequest();
                        
            
            if (data.hasOwnProperty('packVersion')) {
                obj['packVersion'] = ApiClient.convertToType(data['packVersion'], 'String');
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * Sets The version of the Pack.
    * @param {String} packVersion The version of the Pack.
    */
