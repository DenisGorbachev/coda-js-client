...
/**
* The DocList model module.
* @module model/DocList
* @version 1.2.0
*/
export default class DocList {
    /**
    * Constructs a new <code>DocList</code>.
    * List of Coda docs.
    * @alias module:model/DocList
    * @class
    * @param items {Array.<module:model/Doc>} 
    */
    ...
    /**
    * Constructs a <code>DocList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocList} obj Optional instance to populate.
    * @return {module:model/DocList} The populated <code>DocList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Doc]);
            }
    ...
    /**
    * @member {Array.<module:model/Doc>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @param {Array.<module:model/Doc>} items
    */
    setItems(items) {
        this['items'] = items;
    }
