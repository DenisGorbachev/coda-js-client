...
/**
* The PackRateLimit model module.
* @module model/PackRateLimit
* @version 1.2.0
*/
export default class PackRateLimit {
    /**
    * Constructs a new <code>PackRateLimit</code>.
    * Rate limit in Pack settings.
    * @alias module:model/PackRateLimit
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>PackRateLimit</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackRateLimit} obj Optional instance to populate.
    * @return {module:model/PackRateLimit} The populated <code>PackRateLimit</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackRateLimit();
