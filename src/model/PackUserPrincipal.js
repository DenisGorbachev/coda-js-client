...
/**
* The PackUserPrincipal model module.
* @module model/PackUserPrincipal
* @version 1.2.0
*/
export default class PackUserPrincipal {
    /**
    * Constructs a new <code>PackUserPrincipal</code>.
    * @alias module:model/PackUserPrincipal
    * @class
    * @param type {module:model/PackUserPrincipal.TypeEnum} 
    * @param email {String} 
    */
    ...
    /**
    * Constructs a <code>PackUserPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackUserPrincipal} obj Optional instance to populate.
    * @return {module:model/PackUserPrincipal} The populated <code>PackUserPrincipal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackUserPrincipal();
    ...
    /**
    * @member {module:model/PackUserPrincipal.TypeEnum} type
    */
    'type' = undefined;
    /**
    * @member {String} email
    */
    ...
    /**
    * @return {module:model/PackUserPrincipal.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    /**
    * @param {module:model/PackUserPrincipal.TypeEnum} type
    */
    setType(type) {
        this['type'] = type;
    }
