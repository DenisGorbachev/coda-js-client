...
/**
* The RowsDelete model module.
* @module model/RowsDelete
* @version 1.2.0
*/
export default class RowsDelete {
    /**
    * Constructs a new <code>RowsDelete</code>.
    * Payload for deleting rows from a table.
    * @alias module:model/RowsDelete
    * @class
    * @param rowIds {Array.<String>} Row IDs to delete. 
    */
    ...
    /**
    * Constructs a <code>RowsDelete</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowsDelete} obj Optional instance to populate.
    * @return {module:model/RowsDelete} The populated <code>RowsDelete</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowsDelete();
