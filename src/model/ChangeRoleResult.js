...
/**
* The ChangeRoleResult model module.
* @module model/ChangeRoleResult
* @version 1.2.0
*/
export default class ChangeRoleResult {
    /**
    * Constructs a new <code>ChangeRoleResult</code>.
    * The result of changing a user&#x27;s workspace user role.
    * @alias module:model/ChangeRoleResult
    * @class
    * @param roleChangedAt {Date} Timestamp for when the user's role last changed in this workspace.
    */

    constructor(roleChangedAt) {
    ...
    /**
    * Constructs a <code>ChangeRoleResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ChangeRoleResult} obj Optional instance to populate.
    * @return {module:model/ChangeRoleResult} The populated <code>ChangeRoleResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeRoleResult();
