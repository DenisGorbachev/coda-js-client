...
import PackRateLimit from './PackRateLimit';
...
export default class Pack {
    ...
    * @class
    * @param id {Number} ID of the Pack.
    * @param workspaceId {String} The parent workspace for the Pack.
    * @param name {String} The name of the Pack.
    * @param description {String} The full description of the Pack.
    * @param shortDescription {String} A short version of the description of the Pack.
    */

    constructor(id, workspaceId, name, description, shortDescription) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('overallRateLimit')) {
                obj['overallRateLimit'] = PackRateLimit.constructFromObject(data['overallRateLimit']);
            }
            if (data.hasOwnProperty('perConnectionRateLimit')) {
                obj['perConnectionRateLimit'] = PackRateLimit.constructFromObject(data['perConnectionRateLimit']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {module:model/PackRateLimit} overallRateLimit
    */
    'overallRateLimit' = undefined;
    /**
    * @member {module:model/PackRateLimit} perConnectionRateLimit
    */
    'perConnectionRateLimit' = undefined;


    /**
    * Returns ID of the Pack.
    * @return {Number}
    */
    getId() {
        return this.id;
    ...
    /**
    * Sets ID of the Pack.
    * @param {Number} id ID of the Pack.
    */
    setId(id) {
        this['id'] = id;
    }
    /**
    * Returns The link to the logo of the Pack.
    * @return {String}
    */
    getLogoUrl() {
        return this.logoUrl;
    ...
    /**
    * Sets The link to the logo of the Pack.
    * @param {String} logoUrl The link to the logo of the Pack.
    */
    setLogoUrl(logoUrl) {
        this['logoUrl'] = logoUrl;
    }
    /**
    * Returns The parent workspace for the Pack.
    * @return {String}
    */
    getWorkspaceId() {
    ...
    /**
    * Sets The parent workspace for the Pack.
    * @param {String} workspaceId The parent workspace for the Pack.
    */
    ...
    */
    ...
    /**
    * @return {module:model/PackRateLimit}
    */
    getOverallRateLimit() {
    ...
    /**
    * @param {module:model/PackRateLimit} overallRateLimit
    */
    ...
    */
    ...
    /**
    * @param {module:model/PackRateLimit} perConnectionRateLimit
    */
