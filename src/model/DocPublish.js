...
/**
* The DocPublish model module.
* @module model/DocPublish
* @version 1.2.0
*/
export default class DocPublish {
    /**
    * Constructs a new <code>DocPublish</code>.
    * Payload for publishing a doc or or updating its publishing information.
    * @alias module:model/DocPublish
    * @class
    */
    ...
    /**
    * Constructs a <code>DocPublish</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocPublish} obj Optional instance to populate.
    * @return {module:model/DocPublish} The populated <code>DocPublish</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocPublish();
    ...
    */
    ...
    /**
    * Returns Slug for the published doc.
    * @return {String}
    */
    getSlug() {
        return this.slug;
    ...
    /**
    * Sets Slug for the published doc.
    * @param {String} slug Slug for the published doc.
    */
    setSlug(slug) {
        this['slug'] = slug;
    }
    ...
    */
    ...
    /**
    * Returns The names of categories to apply to the document.
    * @return {Array.<String>}
    */
    getCategoryNames() {
    ...
    /**
    * Sets The names of categories to apply to the document.
    * @param {Array.<String>} categoryNames The names of categories to apply to the document.
    */
