...
export default class Column {
    ...
    * @member {module:model/Column.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/Column.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/Column.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
