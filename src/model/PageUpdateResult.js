...
/**
* The PageUpdateResult model module.
* @module model/PageUpdateResult
* @version 1.2.0
*/
export default class PageUpdateResult {
    /**
    * Constructs a new <code>PageUpdateResult</code>.
    * The result of a page update.
    * @alias module:model/PageUpdateResult
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>PageUpdateResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PageUpdateResult} obj Optional instance to populate.
    * @return {module:model/PageUpdateResult} The populated <code>PageUpdateResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageUpdateResult();
    ...
    */
    ...
    /**
    * Returns ID of the updated page.
    * @return {String}
    */
    getId() {
        return this.id;
    ...
    /**
    * Sets ID of the updated page.
    * @param {String} id ID of the updated page.
    */
    setId(id) {
        this['id'] = id;
    }
