...
/**
* The DocCreate model module.
* @module model/DocCreate
* @version 1.2.0
*/
export default class DocCreate {
    /**
    * Constructs a new <code>DocCreate</code>.
    * Payload for creating a new doc.
    * @alias module:model/DocCreate
    * @class
    */
    ...
    /**
    * Constructs a <code>DocCreate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocCreate} obj Optional instance to populate.
    * @return {module:model/DocCreate} The populated <code>DocCreate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocCreate();
            ...
            if (data.hasOwnProperty('sourceDoc')) {
                obj['sourceDoc'] = ApiClient.convertToType(data['sourceDoc'], 'String');
            }
    ...
    */
    ...
    /**
    * Returns Title of the new doc. Defaults to 'Untitled'.
    * @return {String}
    */
    getTitle() {
        return this.title;
    ...
    /**
    * Sets Title of the new doc. Defaults to 'Untitled'.
    * @param {String} title Title of the new doc. Defaults to 'Untitled'.
    */
    setTitle(title) {
        this['title'] = title;
    }
    /**
    * Returns An optional doc ID from which to create a copy.
    * @return {String}
    */
    getSourceDoc() {
    ...
    /**
    * Sets An optional doc ID from which to create a copy.
    * @param {String} sourceDoc An optional doc ID from which to create a copy.
    */
    setSourceDoc(sourceDoc) {
        this['sourceDoc'] = sourceDoc;
    }
    /**
    * Returns The timezone to use for the newly created doc.
    * @return {String}
    */
    getTimezone() {
    ...
    /**
    * Sets The timezone to use for the newly created doc.
    * @param {String} timezone The timezone to use for the newly created doc.
    */
    setTimezone(timezone) {
        this['timezone'] = timezone;
    }
    /**
    * Returns The ID of the folder within which to create this doc. Defaults to your \"My Docs\" folder in the oldest workspace you joined; this is subject to change. You can get this ID by opening the folder in the docs list on your computer and grabbing the `folderId` query parameter. 
    * @return {String}
    */
    getFolderId() {
    ...
    /**
    * Sets The ID of the folder within which to create this doc. Defaults to your \"My Docs\" folder in the oldest workspace you joined; this is subject to change. You can get this ID by opening the folder in the docs list on your computer and grabbing the `folderId` query parameter. 
    * @param {String} folderId The ID of the folder within which to create this doc. Defaults to your \"My Docs\" folder in the oldest workspace you joined; this is subject to change. You can get this ID by opening the folder in the docs list on your computer and grabbing the `folderId` query parameter. 
    */
