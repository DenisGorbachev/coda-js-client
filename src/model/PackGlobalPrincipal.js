...
/**
* The PackGlobalPrincipal model module.
* @module model/PackGlobalPrincipal
* @version 1.2.0
*/
export default class PackGlobalPrincipal {
    /**
    * Constructs a new <code>PackGlobalPrincipal</code>.
    * @alias module:model/PackGlobalPrincipal
    * @class
    * @param type {module:model/PackGlobalPrincipal.TypeEnum} 
    */
    ...
    /**
    * Constructs a <code>PackGlobalPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackGlobalPrincipal} obj Optional instance to populate.
    * @return {module:model/PackGlobalPrincipal} The populated <code>PackGlobalPrincipal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackGlobalPrincipal();
    ...
    /**
    * @member {module:model/PackGlobalPrincipal.TypeEnum} type
    */
    'type' = undefined;
    ...
    /**
    * @return {module:model/PackGlobalPrincipal.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    /**
    * @param {module:model/PackGlobalPrincipal.TypeEnum} type
    */
    setType(type) {
        this['type'] = type;
    }
