...
export default class TableReference {
    ...
    * @param type {module:model/TableReference.TypeEnum} The type of this resource.
    ...
    */
    ...
    constructor(id, type, tableType, href, browserLink, name) {
    ...
    * @member {module:model/TableReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/TableReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/TableReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
