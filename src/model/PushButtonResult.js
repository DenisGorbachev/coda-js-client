...
/**
* The PushButtonResult model module.
* @module model/PushButtonResult
* @version 1.2.0
*/
export default class PushButtonResult {
    /**
    * Constructs a new <code>PushButtonResult</code>.
    * The result of a push button.
    * @alias module:model/PushButtonResult
    * @class
    * @extends module:model/DocumentMutateResponse
    * @param requestId {} An arbitrary unique identifier for this request.
    * @param rowId {} ID of the row where the button exists.
    * @param columnId {} ID of the column where the button exists.
    */

    constructor(requestId, rowId, columnId) {
    ...
    /**
    * Constructs a <code>PushButtonResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PushButtonResult} obj Optional instance to populate.
    * @return {module:model/PushButtonResult} The populated <code>PushButtonResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PushButtonResult();
    ...
    */
    ...
    /**
    * Returns ID of the row where the button exists.
    * @return {String}
    */
    getRowId() {
        return this.rowId;
    ...
    /**
    * Sets ID of the row where the button exists.
    * @param {String} rowId ID of the row where the button exists.
    */
    setRowId(rowId) {
        this['rowId'] = rowId;
    }
    /**
    * Returns ID of the column where the button exists.
    * @return {String}
    */
    getColumnId() {
    ...
    /**
    * Sets ID of the column where the button exists.
    * @param {String} columnId ID of the column where the button exists.
    */
