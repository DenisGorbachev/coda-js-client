...
/**
* The TimeColumnFormat model module.
* @module model/TimeColumnFormat
* @version 1.2.0
*/
export default class TimeColumnFormat {
    /**
    * Constructs a new <code>TimeColumnFormat</code>.
    * Format of a time column.
    * @alias module:model/TimeColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>TimeColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TimeColumnFormat} obj Optional instance to populate.
    * @return {module:model/TimeColumnFormat} The populated <code>TimeColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeColumnFormat();
