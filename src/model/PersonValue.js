...
/**
* The PersonValue model module.
* @module model/PersonValue
* @version 1.2.0
*/
export default class PersonValue {
    /**
    * Constructs a new <code>PersonValue</code>.
    * A named reference to a person, where the person is identified by email address.
    * @alias module:model/PersonValue
    * @class
    ...
    */
    ...
    constructor(context, type, name, email) {
    ...
    /**
    * Constructs a <code>PersonValue</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PersonValue} obj Optional instance to populate.
    * @return {module:model/PersonValue} The populated <code>PersonValue</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonValue();
