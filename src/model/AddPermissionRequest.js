...
export default class AddPermissionRequest {
    ...
    * @class
    * @param access {module:model/AccessType} 
    * @param principal {module:model/Principal} 
    */

    constructor(access, principal) {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('access')) {
                obj['access'] = AccessType.constructFromObject(data['access']);
            }
            if (data.hasOwnProperty('principal')) {
                obj['principal'] = Principal.constructFromObject(data['principal']);
            }
            if (data.hasOwnProperty('suppressEmail')) {
                obj['suppressEmail'] = ApiClient.convertToType(data['suppressEmail'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/AccessType} access
    */
    'access' = undefined;
    /**
    ...
    * @member {Boolean} suppressEmail
    */
    'suppressEmail' = undefined;


    /**
    * @return {module:model/AccessType}
    */
    getAccess() {
        return this.access;
    }
    ...
    /**
    * @param {module:model/AccessType} access
    */
    setAccess(access) {
        this['access'] = access;
    }
    /**
    * @return {module:model/Principal}
    */
    getPrincipal() {
    ...
    */
    ...
    /**
    * Returns When true suppresses email notification
    * @return {Boolean}
    */
    getSuppressEmail() {
    ...
    /**
    * Sets When true suppresses email notification
    * @param {Boolean} suppressEmail When true suppresses email notification
    */
