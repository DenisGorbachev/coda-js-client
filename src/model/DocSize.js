...
/**
* The DocSize model module.
* @module model/DocSize
* @version 1.2.0
*/
export default class DocSize {
    /**
    * Constructs a new <code>DocSize</code>.
    * The number of components within a Coda doc.
    * @alias module:model/DocSize
    * @class
    * @param totalRowCount {Number} The number of rows contained within all tables of the doc.
    * @param tableAndViewCount {Number} The total number of tables and views contained within the doc.
    * @param pageCount {Number} The total number of page contained within the doc.
    * @param overApiSizeLimit {Boolean} If true, indicates that the doc is over the API size limit.
    */

    constructor(totalRowCount, tableAndViewCount, pageCount, overApiSizeLimit) {
        
        
        this['totalRowCount'] = totalRowCount;
        this['tableAndViewCount'] = tableAndViewCount;
        this['pageCount'] = pageCount;
        this['overApiSizeLimit'] = overApiSizeLimit;
        
    }

    /**
    * Constructs a <code>DocSize</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocSize} obj Optional instance to populate.
    * @return {module:model/DocSize} The populated <code>DocSize</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tableAndViewCount')) {
                obj['tableAndViewCount'] = ApiClient.convertToType(data['tableAndViewCount'], 'Number');
            }
            if (data.hasOwnProperty('pageCount')) {
                obj['pageCount'] = ApiClient.convertToType(data['pageCount'], 'Number');
            }
            if (data.hasOwnProperty('overApiSizeLimit')) {
                obj['overApiSizeLimit'] = ApiClient.convertToType(data['overApiSizeLimit'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    * @member {Number} tableAndViewCount
    */
    'tableAndViewCount' = undefined;
    /**
    ...
    * @member {Boolean} overApiSizeLimit
    */
    'overApiSizeLimit' = undefined;


    /**
    * Returns The number of rows contained within all tables of the doc.
    * @return {Number}
    */
    getTotalRowCount() {
    ...
    /**
    * Sets The number of rows contained within all tables of the doc.
    * @param {Number} totalRowCount The number of rows contained within all tables of the doc.
    */
    setTotalRowCount(totalRowCount) {
        this['totalRowCount'] = totalRowCount;
    }
    /**
    * Returns The total number of tables and views contained within the doc.
    * @return {Number}
    */
    getTableAndViewCount() {
        return this.tableAndViewCount;
    }

    /**
    * Sets The total number of tables and views contained within the doc.
    * @param {Number} tableAndViewCount The total number of tables and views contained within the doc.
    */
    setTableAndViewCount(tableAndViewCount) {
        this['tableAndViewCount'] = tableAndViewCount;
    }
    /**
    * Returns The total number of page contained within the doc.
    * @return {Number}
    */
    getPageCount() {
    ...
    /**
    * Sets The total number of page contained within the doc.
    * @param {Number} pageCount The total number of page contained within the doc.
    */
    setPageCount(pageCount) {
        this['pageCount'] = pageCount;
    }
    /**
    * Returns If true, indicates that the doc is over the API size limit.
    * @return {Boolean}
    */
    getOverApiSizeLimit() {
        return this.overApiSizeLimit;
    }

    /**
    * Sets If true, indicates that the doc is over the API size limit.
    * @param {Boolean} overApiSizeLimit If true, indicates that the doc is over the API size limit.
    */
    setOverApiSizeLimit(overApiSizeLimit) {
        this['overApiSizeLimit'] = overApiSizeLimit;
    }
