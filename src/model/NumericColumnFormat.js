...
import ColumnFormatType from './ColumnFormatType';
import SimpleColumnFormat from './SimpleColumnFormat';

/**
* The NumericColumnFormat model module.
* @module model/NumericColumnFormat
* @version 1.2.0
*/
export default class NumericColumnFormat {
    /**
    * Constructs a new <code>NumericColumnFormat</code>.
    * Format of a numeric column.
    * @alias module:model/NumericColumnFormat
    * @class
    * @extends module:model/SimpleColumnFormat
    * @param type {} 
    * @param isArray {} Whether or not this column is an array.
    */

    constructor(type, isArray) {
        SimpleColumnFormat.call(this, type, isArray);
        OneOfColumnFormat.call(this);
        
    }

    /**
    * Constructs a <code>NumericColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumericColumnFormat} obj Optional instance to populate.
    * @return {module:model/NumericColumnFormat} The populated <code>NumericColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumericColumnFormat();
            
            SimpleColumnFormat.constructFromObject(data, obj);
            
            if (data.hasOwnProperty('precision')) {
                obj['precision'] = ApiClient.convertToType(data['precision'], 'Number');
            }
            if (data.hasOwnProperty('useThousandsSeparator')) {
                obj['useThousandsSeparator'] = ApiClient.convertToType(data['useThousandsSeparator'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    * @member {Boolean} useThousandsSeparator
    */
    'useThousandsSeparator' = undefined;

    // Implement OneOfColumnFormat interface:
    ...
    */
    ...
    /**
    * Returns Whether to use a thousands separator (like \",\") to format the numeric value.
    * @return {Boolean}
    */
    ...
    /**
    * Sets Whether to use a thousands separator (like \",\") to format the numeric value.
    * @param {Boolean} useThousandsSeparator Whether to use a thousands separator (like \",\") to format the numeric value.
    */
    setUseThousandsSeparator(useThousandsSeparator) {
