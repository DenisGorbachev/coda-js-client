...
/**
* The RowEdit model module.
* @module model/RowEdit
* @version 1.2.0
*/
export default class RowEdit {
    /**
    * Constructs a new <code>RowEdit</code>.
    * An edit made to a particular row.
    * @alias module:model/RowEdit
    * @class
    * @param cells {Array.<module:model/CellEdit>} 
    */
    ...
    /**
    * Constructs a <code>RowEdit</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowEdit} obj Optional instance to populate.
    * @return {module:model/RowEdit} The populated <code>RowEdit</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cells')) {
                obj['cells'] = ApiClient.convertToType(data['cells'], [CellEdit]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/CellEdit>} cells
    */
    'cells' = undefined;


    /**
    * @return {Array.<module:model/CellEdit>}
    */
    getCells() {
        return this.cells;
    }
    ...
    /**
    * @param {Array.<module:model/CellEdit>} cells
    */
    setCells(cells) {
        this['cells'] = cells;
    }
