...
/**
* The AllOfTableFilter model module.
* @module model/AllOfTableFilter
* @version 1.2.0
*/
export default class AllOfTableFilter {
    /**
    * Constructs a new <code>AllOfTableFilter</code>.
    * @alias module:model/AllOfTableFilter
    * @class
    * @param valid {} Returns whether or not the given formula is valid.
    */
    ...
    /**
    * Constructs a <code>AllOfTableFilter</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfTableFilter} obj Optional instance to populate.
    * @return {module:model/AllOfTableFilter} The populated <code>AllOfTableFilter</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfTableFilter();
            ...
            if (data.hasOwnProperty('hasUserFormula')) {
                obj['hasUserFormula'] = ApiClient.convertToType(data['hasUserFormula'], 'Boolean');
            }
            if (data.hasOwnProperty('hasTodayFormula')) {
                obj['hasTodayFormula'] = ApiClient.convertToType(data['hasTodayFormula'], 'Boolean');
            }
            if (data.hasOwnProperty('hasNowFormula')) {
                obj['hasNowFormula'] = ApiClient.convertToType(data['hasNowFormula'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    * @member {Boolean} hasUserFormula
    */
    'hasUserFormula' = undefined;
    /**
    * Returns whether or not the given formula has a Today() formula within it.
    * @member {Boolean} hasTodayFormula
    */
    'hasTodayFormula' = undefined;
    /**
    * Returns whether or not the given formula has a Now() formula within it.
    * @member {Boolean} hasNowFormula
    */
    'hasNowFormula' = undefined;


    /**
    * Returns Returns whether or not the given formula is valid.
    * @return {Boolean}
    */
    getValid() {
        return this.valid;
    ...
    /**
    * Sets Returns whether or not the given formula is valid.
    * @param {Boolean} valid Returns whether or not the given formula is valid.
    */
    setValid(valid) {
        this['valid'] = valid;
    }
    /**
    * Returns Returns whether or not the given formula can return different results in different contexts (for example, for different users). 
    * @return {Boolean}
    */
    getIsVolatile() {
    ...
    /**
    * Sets Returns whether or not the given formula can return different results in different contexts (for example, for different users). 
    * @param {Boolean} isVolatile Returns whether or not the given formula can return different results in different contexts (for example, for different users). 
    */
    setIsVolatile(isVolatile) {
        this['isVolatile'] = isVolatile;
    }
    /**
    * Returns Returns whether or not the given formula has a User() formula within it.
    * @return {Boolean}
    */
    getHasUserFormula() {
        return this.hasUserFormula;
    }

    /**
    * Sets Returns whether or not the given formula has a User() formula within it.
    * @param {Boolean} hasUserFormula Returns whether or not the given formula has a User() formula within it.
    */
    setHasUserFormula(hasUserFormula) {
        this['hasUserFormula'] = hasUserFormula;
    }
    /**
    * Returns Returns whether or not the given formula has a Today() formula within it.
    * @return {Boolean}
    */
    getHasTodayFormula() {
        return this.hasTodayFormula;
    }

    /**
    * Sets Returns whether or not the given formula has a Today() formula within it.
    * @param {Boolean} hasTodayFormula Returns whether or not the given formula has a Today() formula within it.
    */
    setHasTodayFormula(hasTodayFormula) {
        this['hasTodayFormula'] = hasTodayFormula;
    }
    /**
    * Returns Returns whether or not the given formula has a Now() formula within it.
    * @return {Boolean}
    */
    getHasNowFormula() {
        return this.hasNowFormula;
    }

    /**
    * Sets Returns whether or not the given formula has a Now() formula within it.
    * @param {Boolean} hasNowFormula Returns whether or not the given formula has a Now() formula within it.
    */
    setHasNowFormula(hasNowFormula) {
        this['hasNowFormula'] = hasNowFormula;
    }
