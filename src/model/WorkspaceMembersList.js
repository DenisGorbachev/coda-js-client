...
/**
* The WorkspaceMembersList model module.
* @module model/WorkspaceMembersList
* @version 1.2.0
*/
export default class WorkspaceMembersList {
    /**
    * Constructs a new <code>WorkspaceMembersList</code>.
    * Response for listing workspace users.
    * @alias module:model/WorkspaceMembersList
    * @class
    * @param items {Array.<module:model/WorkspaceUser>} 
    */
    ...
    /**
    * Constructs a <code>WorkspaceMembersList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/WorkspaceMembersList} obj Optional instance to populate.
    * @return {module:model/WorkspaceMembersList} The populated <code>WorkspaceMembersList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkspaceMembersList();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [WorkspaceUser]);
            }
    ...
    /**
    * @member {Array.<module:model/WorkspaceUser>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/WorkspaceUser>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/WorkspaceUser>} items
    */
    setItems(items) {
        this['items'] = items;
    }
