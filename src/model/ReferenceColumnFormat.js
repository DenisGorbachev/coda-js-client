...
/**
* The ReferenceColumnFormat model module.
* @module model/ReferenceColumnFormat
* @version 1.2.0
*/
export default class ReferenceColumnFormat {
    /**
    * Constructs a new <code>ReferenceColumnFormat</code>.
    * Format of a column that refers to another table.
    * @alias module:model/ReferenceColumnFormat
    * @class
    ...
    */
    ...
    constructor(type, isArray, table) {
    ...
    /**
    * Constructs a <code>ReferenceColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReferenceColumnFormat} obj Optional instance to populate.
    * @return {module:model/ReferenceColumnFormat} The populated <code>ReferenceColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReferenceColumnFormat();
            
            SimpleColumnFormat.constructFromObject(data, obj);
            
            if (data.hasOwnProperty('table')) {
                obj['table'] = ApiClient.convertToType(data['table'], ModelObject);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/ModelObject} table
    */
    'table' = undefined;
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} table
    */
    setTable(table) {
        this['table'] = table;
    }
