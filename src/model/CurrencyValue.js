...
export default class CurrencyValue {
    ...
    * @alias module:model/CurrencyValue
    * @class
    ...
    */
    ...
    constructor(context, type, currency, amount) {
    ...
    * @param {module:model/CurrencyValue} obj Optional instance to populate.
    * @return {module:model/CurrencyValue} The populated <code>CurrencyValue</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('amount')) {
                obj['amount'] = CurrencyAmount.constructFromObject(data['amount']);
            }
        }
        return obj;
    }
    ...
    */
    'currency' = undefined;
    /**
    * @member {module:model/CurrencyAmount} amount
    */
    'amount' = undefined;
    ...
    */
    ...
    /**
    * @return {module:model/CurrencyAmount}
    */
    getAmount() {
        return this.amount;
    }
    ...
    /**
    * @param {module:model/CurrencyAmount} amount
    */
    setAmount(amount) {
        this['amount'] = amount;
    }
