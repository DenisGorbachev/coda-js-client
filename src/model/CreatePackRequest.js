...
/**
* The CreatePackRequest model module.
* @module model/CreatePackRequest
* @version 1.2.0
*/
export default class CreatePackRequest {
    /**
    * Constructs a new <code>CreatePackRequest</code>.
    * Payload for creating a Pack.
    * @alias module:model/CreatePackRequest
    * @class
    */
    ...
    /**
    * Constructs a <code>CreatePackRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreatePackRequest} obj Optional instance to populate.
    * @return {module:model/CreatePackRequest} The populated <code>CreatePackRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePackRequest();
    ...
    */
    ...
    /**
    * Returns The parent workspace for the Pack. If unspecified, the user's default workspace will be used.
    * @return {String}
    */
    getWorkspaceId() {
    ...
    /**
    * Sets The parent workspace for the Pack. If unspecified, the user's default workspace will be used.
    * @param {String} workspaceId The parent workspace for the Pack. If unspecified, the user's default workspace will be used.
    */
