...
/**
* The AclMetadata model module.
* @module model/AclMetadata
* @version 1.2.0
*/
export default class AclMetadata {
    /**
    * Constructs a new <code>AclMetadata</code>.
    * Doc level metadata associated with ACL.
    * @alias module:model/AclMetadata
    * @class
    * @param canShare {Boolean} When true, the user of the api can share
    * @param canShareWithOrg {Boolean} When true, the user of the api can share with the org
    */

    constructor(canShare, canShareWithOrg) {
        
        
        this['canShare'] = canShare;
        this['canShareWithOrg'] = canShareWithOrg;
        
    }

    /**
    * Constructs a <code>AclMetadata</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AclMetadata} obj Optional instance to populate.
    * @return {module:model/AclMetadata} The populated <code>AclMetadata</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AclMetadata();
                        
            
            if (data.hasOwnProperty('canShare')) {
                obj['canShare'] = ApiClient.convertToType(data['canShare'], 'Boolean');
            }
            if (data.hasOwnProperty('canShareWithOrg')) {
                obj['canShareWithOrg'] = ApiClient.convertToType(data['canShareWithOrg'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    * @member {Boolean} canShareWithOrg
    */
    'canShareWithOrg' = undefined;


    /**
    * Returns When true, the user of the api can share
    * @return {Boolean}
    */
    getCanShare() {
    ...
    /**
    * Sets When true, the user of the api can share
    * @param {Boolean} canShare When true, the user of the api can share
    */
    setCanShare(canShare) {
        this['canShare'] = canShare;
    }
    /**
    * Returns When true, the user of the api can share with the org
    * @return {Boolean}
    */
    getCanShareWithOrg() {
        return this.canShareWithOrg;
    }

    /**
    * Sets When true, the user of the api can share with the org
    * @param {Boolean} canShareWithOrg When true, the user of the api can share with the org
    */
    setCanShareWithOrg(canShareWithOrg) {
        this['canShareWithOrg'] = canShareWithOrg;
    }
