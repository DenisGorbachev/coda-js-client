...
/**
* The PackAssetUploadCompleteResponse model module.
* @module model/PackAssetUploadCompleteResponse
* @version 1.2.0
*/
export default class PackAssetUploadCompleteResponse {
    /**
    * Constructs a new <code>PackAssetUploadCompleteResponse</code>.
    * Payload for noting a Pack asset upload is complete.
    * @alias module:model/PackAssetUploadCompleteResponse
    * @class
    * @param requestId {String} An arbitrary unique identifier for this request.
    * @param verifiedUploadUrl {String} A post-ingestion url that you can provide to update your Pack's assets.
    */

    constructor(requestId, verifiedUploadUrl) {
        
        
        this['requestId'] = requestId;
        this['verifiedUploadUrl'] = verifiedUploadUrl;
        
    }

    /**
    * Constructs a <code>PackAssetUploadCompleteResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackAssetUploadCompleteResponse} obj Optional instance to populate.
    * @return {module:model/PackAssetUploadCompleteResponse} The populated <code>PackAssetUploadCompleteResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackAssetUploadCompleteResponse();
                        
            
            if (data.hasOwnProperty('requestId')) {
                obj['requestId'] = ApiClient.convertToType(data['requestId'], 'String');
            }
            if (data.hasOwnProperty('verifiedUploadUrl')) {
                obj['verifiedUploadUrl'] = ApiClient.convertToType(data['verifiedUploadUrl'], 'String');
            }
        }
        return obj;
    }
    ...
    * @member {String} verifiedUploadUrl
    */
    'verifiedUploadUrl' = undefined;


    /**
    * Returns An arbitrary unique identifier for this request.
    * @return {String}
    */
    getRequestId() {
    ...
    /**
    * Sets An arbitrary unique identifier for this request.
    * @param {String} requestId An arbitrary unique identifier for this request.
    */
    setRequestId(requestId) {
        this['requestId'] = requestId;
    }
    /**
    * Returns A post-ingestion url that you can provide to update your Pack's assets.
    * @return {String}
    */
    getVerifiedUploadUrl() {
        return this.verifiedUploadUrl;
    }

    /**
    * Sets A post-ingestion url that you can provide to update your Pack's assets.
    * @param {String} verifiedUploadUrl A post-ingestion url that you can provide to update your Pack's assets.
    */
    setVerifiedUploadUrl(verifiedUploadUrl) {
        this['verifiedUploadUrl'] = verifiedUploadUrl;
    }
