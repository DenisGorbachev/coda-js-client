...
export default class ValidationError {
    ...
    * @class
    * @param path {String} A path indicating the affected field, in OGNL notation.
    ...
    */
    ...
    /**
    * Returns A path indicating the affected field, in OGNL notation.
    * @return {String}
    */
    getPath() {
        return this.path;
    ...
    /**
    * Sets A path indicating the affected field, in OGNL notation.
    * @param {String} path A path indicating the affected field, in OGNL notation.
    */
    setPath(path) {
        this['path'] = path;
    }
