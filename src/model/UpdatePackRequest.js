...
import UpdatePackRequestOverallRateLimit from './UpdatePackRequestOverallRateLimit';

/**
* The UpdatePackRequest model module.
* @module model/UpdatePackRequest
* @version 1.2.0
*/
export default class UpdatePackRequest {
    /**
    * Constructs a new <code>UpdatePackRequest</code>.
    * Payload for updating a Pack.
    * @alias module:model/UpdatePackRequest
    * @class
    */
    ...
    /**
    * Constructs a <code>UpdatePackRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UpdatePackRequest} obj Optional instance to populate.
    * @return {module:model/UpdatePackRequest} The populated <code>UpdatePackRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePackRequest();
                        
            
            if (data.hasOwnProperty('overallRateLimit')) {
                obj['overallRateLimit'] = UpdatePackRequestOverallRateLimit.constructFromObject(data['overallRateLimit']);
            }
            if (data.hasOwnProperty('perConnectionRateLimit')) {
                obj['perConnectionRateLimit'] = UpdatePackRequestOverallRateLimit.constructFromObject(data['perConnectionRateLimit']);
            }
    ...
    /**
    * @member {module:model/UpdatePackRequestOverallRateLimit} overallRateLimit
    */
    'overallRateLimit' = undefined;
    /**
    * @member {module:model/UpdatePackRequestOverallRateLimit} perConnectionRateLimit
    */
    'perConnectionRateLimit' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {module:model/UpdatePackRequestOverallRateLimit}
    */
    getOverallRateLimit() {
        return this.overallRateLimit;
    }

    /**
    * @param {module:model/UpdatePackRequestOverallRateLimit} overallRateLimit
    */
    setOverallRateLimit(overallRateLimit) {
        this['overallRateLimit'] = overallRateLimit;
    }
    /**
    * @return {module:model/UpdatePackRequestOverallRateLimit}
    */
    getPerConnectionRateLimit() {
        return this.perConnectionRateLimit;
    }

    /**
    * @param {module:model/UpdatePackRequestOverallRateLimit} perConnectionRateLimit
    */
    setPerConnectionRateLimit(perConnectionRateLimit) {
        this['perConnectionRateLimit'] = perConnectionRateLimit;
    }
    /**
    ...
    */
    ...
    /**
    * Returns The full description of the Pack.
    * @return {String}
    */
    getDescription() {
    ...
    /**
    * Sets The full description of the Pack.
    * @param {String} description The full description of the Pack.
    */
    setDescription(description) {
        this['description'] = description;
    }
    /**
    * Returns A short version of the description of the Pack.
    * @return {String}
    */
    getShortDescription() {
    ...
    /**
    * Sets A short version of the description of the Pack.
    * @param {String} shortDescription A short version of the description of the Pack.
    */
