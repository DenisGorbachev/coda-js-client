...
import WorkspaceRoleActivity from './WorkspaceRoleActivity';

/**
* The GetWorkspaceRoleActivity model module.
* @module model/GetWorkspaceRoleActivity
* @version 1.2.0
*/
export default class GetWorkspaceRoleActivity {
    /**
    * Constructs a new <code>GetWorkspaceRoleActivity</code>.
    * Response for getting workspace role activity.
    * @alias module:model/GetWorkspaceRoleActivity
    * @class
    * @param items {Array.<module:model/WorkspaceRoleActivity>} 
    */
    ...
    /**
    * Constructs a <code>GetWorkspaceRoleActivity</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GetWorkspaceRoleActivity} obj Optional instance to populate.
    * @return {module:model/GetWorkspaceRoleActivity} The populated <code>GetWorkspaceRoleActivity</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetWorkspaceRoleActivity();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [WorkspaceRoleActivity]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/WorkspaceRoleActivity>} items
    */
    'items' = undefined;


    /**
    * @return {Array.<module:model/WorkspaceRoleActivity>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/WorkspaceRoleActivity>} items
    */
    setItems(items) {
        this['items'] = items;
    }
