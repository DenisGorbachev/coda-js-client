...
/**
* The DomainPrincipal model module.
* @module model/DomainPrincipal
* @version 1.2.0
*/
export default class DomainPrincipal {
    /**
    * Constructs a new <code>DomainPrincipal</code>.
    * @alias module:model/DomainPrincipal
    * @class
    * @param type {module:model/PrincipalType} 
    * @param domain {String} Domain for the principal.
    */

    constructor(type, domain) {
        
        OneOfPrincipal.call(this);
        this['type'] = type;
        this['domain'] = domain;
    ...
    /**
    * Constructs a <code>DomainPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DomainPrincipal} obj Optional instance to populate.
    * @return {module:model/DomainPrincipal} The populated <code>DomainPrincipal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainPrincipal();
    ...
    */
    ...
    // Implement OneOfPrincipal interface:
    
    /**
    * @return {module:model/PrincipalType}
    */
    getType() {
        return this.type;
    }
    ...
    /**
    * @param {module:model/PrincipalType} type
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns Domain for the principal.
    * @return {String}
    */
    getDomain() {
        return this.domain;
    ...
    /**
    * Sets Domain for the principal.
    * @param {String} domain Domain for the principal.
    */
    setDomain(domain) {
        this['domain'] = domain;
    }
