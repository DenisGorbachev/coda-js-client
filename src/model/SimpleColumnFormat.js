...
/**
* The SimpleColumnFormat model module.
* @module model/SimpleColumnFormat
* @version 1.2.0
*/
export default class SimpleColumnFormat {
    /**
    * Constructs a new <code>SimpleColumnFormat</code>.
    * Format of a simple column.
    * @alias module:model/SimpleColumnFormat
    * @class
    * @param type {module:model/ColumnFormatType} 
    * @param isArray {Boolean} Whether or not this column is an array.
    */
    ...
    /**
    * Constructs a <code>SimpleColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SimpleColumnFormat} obj Optional instance to populate.
    * @return {module:model/SimpleColumnFormat} The populated <code>SimpleColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleColumnFormat();
                        
            
            if (data.hasOwnProperty('type')) {
                obj['type'] = ColumnFormatType.constructFromObject(data['type']);
            }
    ...
    /**
    * @member {module:model/ColumnFormatType} type
    */
    'type' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {module:model/ColumnFormatType}
    */
    getType() {
        return this.type;
    }
    ...
    /**
    * @param {module:model/ColumnFormatType} type
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns Whether or not this column is an array.
    * @return {Boolean}
    */
    getIsArray() {
        return this.isArray;
    ...
    /**
    * Sets Whether or not this column is an array.
    * @param {Boolean} isArray Whether or not this column is an array.
    */
    setIsArray(isArray) {
        this['isArray'] = isArray;
    }
