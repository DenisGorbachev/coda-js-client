...
/**
* The PackAssetUploadInfo model module.
* @module model/PackAssetUploadInfo
* @version 1.2.0
*/
export default class PackAssetUploadInfo {
    /**
    * Constructs a new <code>PackAssetUploadInfo</code>.
    * Information indicating where to upload the Pack asset, and an endpoint to mark the upload as complete.
    * @alias module:model/PackAssetUploadInfo
    * @class
    * @param uploadUrl {String} A signed url to be used for uploading a Pack asset.
    * @param packAssetUploadedPathName {String} An endpoint to mark the upload as complete.
    */

    constructor(uploadUrl, packAssetUploadedPathName) {
        
        
        this['uploadUrl'] = uploadUrl;
        this['packAssetUploadedPathName'] = packAssetUploadedPathName;
        
    }

    /**
    * Constructs a <code>PackAssetUploadInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackAssetUploadInfo} obj Optional instance to populate.
    * @return {module:model/PackAssetUploadInfo} The populated <code>PackAssetUploadInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackAssetUploadInfo();
                        
            
            if (data.hasOwnProperty('uploadUrl')) {
                obj['uploadUrl'] = ApiClient.convertToType(data['uploadUrl'], 'String');
            }
            if (data.hasOwnProperty('packAssetUploadedPathName')) {
                obj['packAssetUploadedPathName'] = ApiClient.convertToType(data['packAssetUploadedPathName'], 'String');
            }
        }
        return obj;
    }
    ...
    * @member {String} packAssetUploadedPathName
    */
    'packAssetUploadedPathName' = undefined;


    /**
    * Returns A signed url to be used for uploading a Pack asset.
    * @return {String}
    */
    getUploadUrl() {
    ...
    /**
    * Sets A signed url to be used for uploading a Pack asset.
    * @param {String} uploadUrl A signed url to be used for uploading a Pack asset.
    */
    setUploadUrl(uploadUrl) {
        this['uploadUrl'] = uploadUrl;
    }
    /**
    * Returns An endpoint to mark the upload as complete.
    * @return {String}
    */
    getPackAssetUploadedPathName() {
        return this.packAssetUploadedPathName;
    }

    /**
    * Sets An endpoint to mark the upload as complete.
    * @param {String} packAssetUploadedPathName An endpoint to mark the upload as complete.
    */
    setPackAssetUploadedPathName(packAssetUploadedPathName) {
        this['packAssetUploadedPathName'] = packAssetUploadedPathName;
    }
