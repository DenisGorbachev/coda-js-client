...
/**
* The ImageUrlValue model module.
* @module model/ImageUrlValue
* @version 1.2.0
*/
export default class ImageUrlValue {
    /**
    * Constructs a new <code>ImageUrlValue</code>.
    * A named url of an image along with metadata.
    * @alias module:model/ImageUrlValue
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>ImageUrlValue</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ImageUrlValue} obj Optional instance to populate.
    * @return {module:model/ImageUrlValue} The populated <code>ImageUrlValue</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageUrlValue();
    ...
    */
    ...
    /**
    * @return {module:model/ImageStatus}
    */
    getStatus() {
        return this.status;
    }
    ...
    /**
    * @param {module:model/ImageStatus} status
    */
    setStatus(status) {
        this['status'] = status;
    }
