...
/**
* The ScaleColumnFormat model module.
* @module model/ScaleColumnFormat
* @version 1.2.0
*/
export default class ScaleColumnFormat {
    /**
    * Constructs a new <code>ScaleColumnFormat</code>.
    * Format of a numeric column that renders as a scale, like star ratings.
    * @alias module:model/ScaleColumnFormat
    * @class
    * @extends module:model/SimpleColumnFormat
    * @param type {} 
    * @param isArray {} Whether or not this column is an array.
    * @param maximum {} The maximum number allowed for this scale.
    * @param icon {} 
    */

    constructor(type, isArray, maximum, icon) {
    ...
    /**
    * Constructs a <code>ScaleColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ScaleColumnFormat} obj Optional instance to populate.
    * @return {module:model/ScaleColumnFormat} The populated <code>ScaleColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScaleColumnFormat();
            ...
            if (data.hasOwnProperty('icon')) {
                obj['icon'] = ApiClient.convertToType(data['icon'], ModelObject);
            }
        }
        return obj;
    }
    ...
    */
    'maximum' = undefined;
    /**
    * @member {module:model/ModelObject} icon
    */
    'icon' = undefined;
    ...
    /**
    * Returns The maximum number allowed for this scale.
    * @return {Number}
    */
    getMaximum() {
        return this.maximum;
    ...
    /**
    * Sets The maximum number allowed for this scale.
    * @param {Number} maximum The maximum number allowed for this scale.
    */
    setMaximum(maximum) {
        this['maximum'] = maximum;
    }
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} icon
    */
    setIcon(icon) {
        this['icon'] = icon;
    }
