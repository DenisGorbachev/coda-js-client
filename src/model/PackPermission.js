...
import PackAccessType from './PackAccessType';
import PackPrincipal from './PackPrincipal';

/**
* The PackPermission model module.
* @module model/PackPermission
* @version 1.2.0
*/
export default class PackPermission {
    /**
    * Constructs a new <code>PackPermission</code>.
    * Metadata about a Pack permission.
    * @alias module:model/PackPermission
    * @class
    * @param id {String} Id for the Permission
    * @param principal {module:model/PackPrincipal} 
    * @param access {module:model/PackAccessType} 
    */

    constructor(id, principal, access) {
    ...
    /**
    * Constructs a <code>PackPermission</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackPermission} obj Optional instance to populate.
    * @return {module:model/PackPermission} The populated <code>PackPermission</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackPermission();
            ...
            if (data.hasOwnProperty('principal')) {
                obj['principal'] = PackPrincipal.constructFromObject(data['principal']);
            }
            if (data.hasOwnProperty('access')) {
                obj['access'] = PackAccessType.constructFromObject(data['access']);
            }
        }
        return obj;
    }
    ...
    */
    'id' = undefined;
    /**
    * @member {module:model/PackPrincipal} principal
    */
    'principal' = undefined;
    /**
    * @member {module:model/PackAccessType} access
    */
    'access' = undefined;


    /**
    * Returns Id for the Permission
    * @return {String}
    */
    getId() {
        return this.id;
    ...
    /**
    * Sets Id for the Permission
    * @param {String} id Id for the Permission
    */
    setId(id) {
        this['id'] = id;
    }
    /**
    * @return {module:model/PackPrincipal}
    */
    getPrincipal() {
    ...
    /**
    * @param {module:model/PackPrincipal} principal
    */
    setPrincipal(principal) {
        this['principal'] = principal;
    }
    /**
    * @return {module:model/PackAccessType}
    */
    getAccess() {
        return this.access;
    }
    ...
    /**
    * @param {module:model/PackAccessType} access
    */
    setAccess(access) {
        this['access'] = access;
    }
