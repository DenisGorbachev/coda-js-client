...
/**
* The MutationStatus model module.
* @module model/MutationStatus
* @version 1.2.0
*/
export default class MutationStatus {
    /**
    * Constructs a new <code>MutationStatus</code>.
    * The status of an asynchronous mutation.
    * @alias module:model/MutationStatus
    * @class
    * @param completed {Boolean} Returns whether the mutation has completed.
    */
    ...
    /**
    * Constructs a <code>MutationStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MutationStatus} obj Optional instance to populate.
    * @return {module:model/MutationStatus} The populated <code>MutationStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MutationStatus();
    ...
    */
    ...
    /**
    * Returns Returns whether the mutation has completed.
    * @return {Boolean}
    */
    getCompleted() {
    ...
    /**
    * Sets Returns whether the mutation has completed.
    * @param {Boolean} completed Returns whether the mutation has completed.
    */
