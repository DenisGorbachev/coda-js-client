...
import DocPublishMode from './DocPublishMode';

/**
* The DocPublished model module.
* @module model/DocPublished
* @version 1.2.0
*/
export default class DocPublished {
    /**
    * Constructs a new <code>DocPublished</code>.
    * Information about the publishing state of the document.
    * @alias module:model/DocPublished
    * @class
    * @param browserLink {String} URL to the published doc.
    * @param copyable {Boolean} If true, the doc will display a copy button in the header.
    * @param discoverable {Boolean} If true, indicates that the doc is discoverable.
    * @param earnCredit {Boolean} If true, new users may be required to sign in to view content within this document. You will receive Coda credit for each user who signs up via your doc. 
    * @param mode {module:model/DocPublishMode} 
    * @param categories {Array.<module:model/DocCategory>} Categories applied to the doc.
    */

    constructor(browserLink, copyable, discoverable, earnCredit, mode, categories) {
    ...
    /**
    * Constructs a <code>DocPublished</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocPublished} obj Optional instance to populate.
    * @return {module:model/DocPublished} The populated <code>DocPublished</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocPublished();
            ...
            if (data.hasOwnProperty('earnCredit')) {
                obj['earnCredit'] = ApiClient.convertToType(data['earnCredit'], 'Boolean');
            }
            if (data.hasOwnProperty('mode')) {
                obj['mode'] = DocPublishMode.constructFromObject(data['mode']);
            }
            if (data.hasOwnProperty('categories')) {
                obj['categories'] = ApiClient.convertToType(data['categories'], [DocCategory]);
            }
        }
        return obj;
    }
    ...
    * @member {Boolean} earnCredit
    */
    'earnCredit' = undefined;
    /**
    * @member {module:model/DocPublishMode} mode
    */
    'mode' = undefined;
    /**
    * Categories applied to the doc.
    * @member {Array.<module:model/DocCategory>} categories
    */
    'categories' = undefined;


    /**
    * Returns Description of the published doc.
    * @return {String}
    */
    getDescription() {
    ...
    /**
    * Sets Description of the published doc.
    * @param {String} description Description of the published doc.
    */
    setDescription(description) {
        this['description'] = description;
    }
    /**
    * Returns URL to the published doc.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets URL to the published doc.
    * @param {String} browserLink URL to the published doc.
    */
    setBrowserLink(browserLink) {
        this['browserLink'] = browserLink;
    }
    /**
    * Returns URL to the cover image for the published doc.
    * @return {String}
    */
    getImageLink() {
    ...
    /**
    * Sets URL to the cover image for the published doc.
    * @param {String} imageLink URL to the cover image for the published doc.
    */
    setImageLink(imageLink) {
        this['imageLink'] = imageLink;
    }
    /**
    * Returns If true, the doc will display a copy button in the header.
    * @return {Boolean}
    */
    getCopyable() {
    ...
    /**
    * Sets If true, the doc will display a copy button in the header.
    * @param {Boolean} copyable If true, the doc will display a copy button in the header.
    */
    setCopyable(copyable) {
        this['copyable'] = copyable;
    }
    /**
    * Returns If true, indicates that the doc is discoverable.
    * @return {Boolean}
    */
    getDiscoverable() {
    ...
    /**
    * Sets If true, indicates that the doc is discoverable.
    * @param {Boolean} discoverable If true, indicates that the doc is discoverable.
    */
    setDiscoverable(discoverable) {
        this['discoverable'] = discoverable;
    }
    /**
    * Returns If true, new users may be required to sign in to view content within this document. You will receive Coda credit for each user who signs up via your doc. 
    * @return {Boolean}
    */
    getEarnCredit() {
    ...
    /**
    * Sets If true, new users may be required to sign in to view content within this document. You will receive Coda credit for each user who signs up via your doc. 
    * @param {Boolean} earnCredit If true, new users may be required to sign in to view content within this document. You will receive Coda credit for each user who signs up via your doc. 
    */
    setEarnCredit(earnCredit) {
        this['earnCredit'] = earnCredit;
    }
    /**
    * @return {module:model/DocPublishMode}
    */
    getMode() {
        return this.mode;
    }
    ...
    /**
    * @param {module:model/DocPublishMode} mode
    */
    setMode(mode) {
        this['mode'] = mode;
    }
    /**
    * Returns Categories applied to the doc.
    * @return {Array.<module:model/DocCategory>}
    */
    getCategories() {
    ...
    /**
    * Sets Categories applied to the doc.
    * @param {Array.<module:model/DocCategory>} categories Categories applied to the doc.
    */
