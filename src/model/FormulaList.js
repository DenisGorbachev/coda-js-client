...
export default class FormulaList {
    ...
    * @class
    * @param items {Array.<module:model/FormulaReference>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [FormulaReference]);
            }
    ...
    /**
    * @member {Array.<module:model/FormulaReference>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/FormulaReference>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/FormulaReference>} items
    */
    setItems(items) {
        this['items'] = items;
    }
