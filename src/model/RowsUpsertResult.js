...
import DocumentMutateResponse from './DocumentMutateResponse';

/**
* The RowsUpsertResult model module.
* @module model/RowsUpsertResult
* @version 1.2.0
*/
export default class RowsUpsertResult {
    /**
    * Constructs a new <code>RowsUpsertResult</code>.
    * The result of a rows insert/upsert operation.
    * @alias module:model/RowsUpsertResult
    * @class
    * @extends module:model/DocumentMutateResponse
    * @param requestId {} An arbitrary unique identifier for this request.
    */

    constructor(requestId) {
        DocumentMutateResponse.call(this, requestId);
        
        
    }

    /**
    * Constructs a <code>RowsUpsertResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowsUpsertResult} obj Optional instance to populate.
    * @return {module:model/RowsUpsertResult} The populated <code>RowsUpsertResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowsUpsertResult();
            
            DocumentMutateResponse.constructFromObject(data, obj);
            
            if (data.hasOwnProperty('addedRowIds')) {
                obj['addedRowIds'] = ApiClient.convertToType(data['addedRowIds'], ['String']);
            }
        }
        return obj;
    }
    ...
    * @member {Array.<String>} addedRowIds
    */
    'addedRowIds' = undefined;


    /**
    * Returns Row IDs for rows that will be added. Only applicable when keyColumns is not set or empty.
    * @return {Array.<String>}
    */
    getAddedRowIds() {
        return this.addedRowIds;
    }

    /**
    * Sets Row IDs for rows that will be added. Only applicable when keyColumns is not set or empty.
    * @param {Array.<String>} addedRowIds Row IDs for rows that will be added. Only applicable when keyColumns is not set or empty.
    */
    setAddedRowIds(addedRowIds) {
        this['addedRowIds'] = addedRowIds;
    }
