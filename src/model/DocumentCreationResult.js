...
/**
* The DocumentCreationResult model module.
* @module model/DocumentCreationResult
* @version 1.2.0
*/
export default class DocumentCreationResult {
    /**
    * Constructs a new <code>DocumentCreationResult</code>.
    * The result of a doc creation.
    * @alias module:model/DocumentCreationResult
    * @class
    * @param id {String} ID of the Coda doc.
    * @param type {module:model/DocumentCreationResult.TypeEnum} The type of this resource.
    ...
    */
    ...
    /**
    * Constructs a <code>DocumentCreationResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocumentCreationResult} obj Optional instance to populate.
    * @return {module:model/DocumentCreationResult} The populated <code>DocumentCreationResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentCreationResult();
    ...
    * @member {module:model/DocumentCreationResult.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/DocumentCreationResult.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/DocumentCreationResult.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
