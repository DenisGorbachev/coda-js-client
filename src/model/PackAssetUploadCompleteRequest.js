...
import PackAssetType from './PackAssetType';

/**
* The PackAssetUploadCompleteRequest model module.
* @module model/PackAssetUploadCompleteRequest
* @version 1.2.0
*/
export default class PackAssetUploadCompleteRequest {
    /**
    * Constructs a new <code>PackAssetUploadCompleteRequest</code>.
    * Payload for noting a Pack asset upload is complete.
    * @alias module:model/PackAssetUploadCompleteRequest
    * @class
    * @param packAssetType {module:model/PackAssetType} 
    */

    constructor(packAssetType) {
        
        
        this['packAssetType'] = packAssetType;
        
    }

    /**
    * Constructs a <code>PackAssetUploadCompleteRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackAssetUploadCompleteRequest} obj Optional instance to populate.
    * @return {module:model/PackAssetUploadCompleteRequest} The populated <code>PackAssetUploadCompleteRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackAssetUploadCompleteRequest();
                        
            
            if (data.hasOwnProperty('packAssetType')) {
                obj['packAssetType'] = PackAssetType.constructFromObject(data['packAssetType']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/PackAssetType} packAssetType
    */
    'packAssetType' = undefined;


    /**
    * @return {module:model/PackAssetType}
    */
    getPackAssetType() {
        return this.packAssetType;
    }

    /**
    * @param {module:model/PackAssetType} packAssetType
    */
    setPackAssetType(packAssetType) {
        this['packAssetType'] = packAssetType;
    }
