...
export default class Table {
    ...
    * @param type {module:model/Table.TypeEnum} The type of this resource.
    * @param tableType {module:model/TableType} 
    * @param href {String} API link to the table.
    * @param browserLink {String} Browser-friendly link to the table.
    * @param name {String} Name of the table.
    * @param parent {module:model/PageReference} 
    * @param displayColumn {module:model/ColumnReference} 
    * @param rowCount {Number} Total number of rows in the table.
    * @param sorts {Array.<module:model/Sort>} Any sorts applied to the table.
    * @param layout {module:model/Layout} 
    * @param createdAt {Date} Timestamp for when the table was created.
    * @param updatedAt {Date} Timestamp for when the table was last modified.
    */

    constructor(id, type, tableType, href, browserLink, name, parent, displayColumn, rowCount, sorts, layout, createdAt, updatedAt) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tableType')) {
                obj['tableType'] = TableType.constructFromObject(data['tableType']);
            }
            ...
            if (data.hasOwnProperty('parent')) {
                obj['parent'] = PageReference.constructFromObject(data['parent']);
            }
            if (data.hasOwnProperty('parentTable')) {
                obj['parentTable'] = TableReference.constructFromObject(data['parentTable']);
            }
            if (data.hasOwnProperty('displayColumn')) {
                obj['displayColumn'] = ColumnReference.constructFromObject(data['displayColumn']);
            }
            ...
            if (data.hasOwnProperty('filter')) {
                obj['filter'] = ApiClient.convertToType(data['filter'], ModelObject);
            }
    ...
    */
    'type' = undefined;
    /**
    * @member {module:model/TableType} tableType
    */
    'tableType' = undefined;
    /**
    ...
    */
    'name' = undefined;
    /**
    * @member {module:model/PageReference} parent
    */
    'parent' = undefined;
    /**
    * @member {module:model/TableReference} parentTable
    */
    'parentTable' = undefined;
    /**
    * @member {module:model/ColumnReference} displayColumn
    */
    ...
    */
    'layout' = undefined;
    /**
    * @member {module:model/ModelObject} filter
    */
    'filter' = undefined;
    /**
    ...
    * @return {module:model/Table.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/Table.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * @return {module:model/TableType}
    */
    getTableType() {
    ...
    /**
    * @param {module:model/TableType} tableType
    */
    setTableType(tableType) {
        this['tableType'] = tableType;
    }
    /**
    * Returns API link to the table.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the table.
    * @param {String} href API link to the table.
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * Returns Browser-friendly link to the table.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Browser-friendly link to the table.
    * @param {String} browserLink Browser-friendly link to the table.
    */
    ...
    */
    ...
    /**
    * @return {module:model/PageReference}
    */
    getParent() {
        return this.parent;
    }
    ...
    /**
    * @param {module:model/PageReference} parent
    */
    setParent(parent) {
        this['parent'] = parent;
    }
    ...
    */
    ...
    /**
    * @param {module:model/TableReference} parentTable
    */
    setParentTable(parentTable) {
        this['parentTable'] = parentTable;
    }
    /**
    * @return {module:model/ColumnReference}
    */
    getDisplayColumn() {
    ...
    /**
    * @param {module:model/ColumnReference} displayColumn
    */
    ...
    */
    ...
    /**
    * Sets Total number of rows in the table.
    ...
    */
    ...
    /**
    * Returns Any sorts applied to the table.
    * @return {Array.<module:model/Sort>}
    */
    getSorts() {
        return this.sorts;
    }
    ...
    /**
    * Sets Any sorts applied to the table.
    * @param {Array.<module:model/Sort>} sorts Any sorts applied to the table.
    */
    setSorts(sorts) {
        this['sorts'] = sorts;
    }
    /**
    * @return {module:model/Layout}
    */
    getLayout() {
        return this.layout;
    }
    ...
    /**
    * @param {module:model/Layout} layout
    */
    setLayout(layout) {
        this['layout'] = layout;
    }
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} filter
    */
    setFilter(filter) {
        this['filter'] = filter;
    }
    /**
    * Returns Timestamp for when the table was created.
    * @return {Date}
    */
    getCreatedAt() {
    ...
    /**
    * Sets Timestamp for when the table was created.
    * @param {Date} createdAt Timestamp for when the table was created.
    */
    setCreatedAt(createdAt) {
        this['createdAt'] = createdAt;
    }
    /**
    * Returns Timestamp for when the table was last modified.
    * @return {Date}
    */
    getUpdatedAt() {
    ...
    /**
    * Sets Timestamp for when the table was last modified.
    * @param {Date} updatedAt Timestamp for when the table was last modified.
    */
