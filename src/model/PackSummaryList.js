...
/**
* The PackSummaryList model module.
* @module model/PackSummaryList
* @version 1.2.0
*/
export default class PackSummaryList {
    /**
    * Constructs a new <code>PackSummaryList</code>.
    * List of Pack summaries.
    * @alias module:model/PackSummaryList
    * @class
    * @param items {Array.<module:model/PackSummary>} 
    */
    ...
    /**
    * Constructs a <code>PackSummaryList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackSummaryList} obj Optional instance to populate.
    * @return {module:model/PackSummaryList} The populated <code>PackSummaryList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackSummaryList();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [PackSummary]);
            }
    ...
    /**
    * @member {Array.<module:model/PackSummary>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/PackSummary>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/PackSummary>} items
    */
    setItems(items) {
        this['items'] = items;
    }
