...
/**
* The UrlValue model module.
* @module model/UrlValue
* @version 1.2.0
*/
export default class UrlValue {
    /**
    * Constructs a new <code>UrlValue</code>.
    * A named hyperlink to an arbitrary url.
    * @alias module:model/UrlValue
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>UrlValue</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UrlValue} obj Optional instance to populate.
    * @return {module:model/UrlValue} The populated <code>UrlValue</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UrlValue();
    ...
    */
    ...
    /**
    * Returns The user-visible text of the hyperlink.
    * @return {String}
    */
    getName() {
        return this.name;
    ...
    /**
    * Sets The user-visible text of the hyperlink.
    * @param {String} name The user-visible text of the hyperlink.
    */
    setName(name) {
        this['name'] = name;
    }
