...
import InlineResponse4001CodaDetail from './InlineResponse4001CodaDetail';
...
export default class InlineResponse4001 {
    ...
    * @class
    * @param statusCode {Number} HTTP status code of the error.
    * @param statusMessage {String} HTTP status message of the error.
    * @param message {String} Any additional context on the error, or the same as `statusMessage` otherwise.
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('codaDetail')) {
                obj['codaDetail'] = InlineResponse4001CodaDetail.constructFromObject(data['codaDetail']);
            }
        }
        return obj;
    }
    ...
    */
    'message' = undefined;
    /**
    * @member {module:model/InlineResponse4001CodaDetail} codaDetail
    */
    'codaDetail' = undefined;
    ...
    */
    ...
    /**
    * Sets HTTP status code of the error.
    ...
    */
    ...
    /**
    * Returns HTTP status message of the error.
    * @return {String}
    */
    getStatusMessage() {
    ...
    /**
    * Sets HTTP status message of the error.
    * @param {String} statusMessage HTTP status message of the error.
    */
    setStatusMessage(statusMessage) {
        this['statusMessage'] = statusMessage;
    }
    /**
    * Returns Any additional context on the error, or the same as `statusMessage` otherwise.
    * @return {String}
    */
    getMessage() {
        return this.message;
    ...
    /**
    * Sets Any additional context on the error, or the same as `statusMessage` otherwise.
    * @param {String} message Any additional context on the error, or the same as `statusMessage` otherwise.
    */
    setMessage(message) {
        this['message'] = message;
    }
    /**
    * @return {module:model/InlineResponse4001CodaDetail}
    */
    getCodaDetail() {
        return this.codaDetail;
    }

    /**
    * @param {module:model/InlineResponse4001CodaDetail} codaDetail
    */
    setCodaDetail(codaDetail) {
        this['codaDetail'] = codaDetail;
    }
