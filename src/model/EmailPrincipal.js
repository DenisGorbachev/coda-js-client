...
/**
* The EmailPrincipal model module.
* @module model/EmailPrincipal
* @version 1.2.0
*/
export default class EmailPrincipal {
    /**
    * Constructs a new <code>EmailPrincipal</code>.
    * @alias module:model/EmailPrincipal
    * @class
    * @param type {module:model/PrincipalType} 
    * @param email {String} Email for the principal.
    */
    ...
    /**
    * Constructs a <code>EmailPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/EmailPrincipal} obj Optional instance to populate.
    * @return {module:model/EmailPrincipal} The populated <code>EmailPrincipal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailPrincipal();
    ...
    */
    ...
    /**
    * Returns Email for the principal.
    * @return {String}
    */
    getEmail() {
        return this.email;
    ...
    /**
    * Sets Email for the principal.
    * @param {String} email Email for the principal.
    */
    setEmail(email) {
        this['email'] = email;
    }
