...
/**
* The WorkspaceRoleActivity model module.
* @module model/WorkspaceRoleActivity
* @version 1.2.0
*/
export default class WorkspaceRoleActivity {
    /**
    * Constructs a new <code>WorkspaceRoleActivity</code>.
    * Metadata for workspace role activity.
    * @alias module:model/WorkspaceRoleActivity
    * @class
    * @param month {String} Month corresponding to the data.
    * @param activeAdminCount {Number} Number of active Admins.
    * @param activeDocMakerCount {Number} Number of active Doc Makers.
    * @param activeEditorCount {Number} Number of active Editors.
    * @param inactiveAdminCount {Number} Number of inactive Admins.
    * @param inactiveDocMakerCount {Number} Number of inactive Doc Makers.
    * @param inactiveEditorCount {Number} Number of inactive Editor users.
    */

    constructor(month, activeAdminCount, activeDocMakerCount, activeEditorCount, inactiveAdminCount, inactiveDocMakerCount, inactiveEditorCount) {
        
        
        this['month'] = month;
        this['activeAdminCount'] = activeAdminCount;
        this['activeDocMakerCount'] = activeDocMakerCount;
        this['activeEditorCount'] = activeEditorCount;
        this['inactiveAdminCount'] = inactiveAdminCount;
        this['inactiveDocMakerCount'] = inactiveDocMakerCount;
        this['inactiveEditorCount'] = inactiveEditorCount;
        
    }

    /**
    * Constructs a <code>WorkspaceRoleActivity</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/WorkspaceRoleActivity} obj Optional instance to populate.
    * @return {module:model/WorkspaceRoleActivity} The populated <code>WorkspaceRoleActivity</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkspaceRoleActivity();
                        
            
            if (data.hasOwnProperty('month')) {
                obj['month'] = ApiClient.convertToType(data['month'], 'String');
            }
            if (data.hasOwnProperty('activeAdminCount')) {
                obj['activeAdminCount'] = ApiClient.convertToType(data['activeAdminCount'], 'Number');
            }
            if (data.hasOwnProperty('activeDocMakerCount')) {
                obj['activeDocMakerCount'] = ApiClient.convertToType(data['activeDocMakerCount'], 'Number');
            }
            if (data.hasOwnProperty('activeEditorCount')) {
                obj['activeEditorCount'] = ApiClient.convertToType(data['activeEditorCount'], 'Number');
            }
            if (data.hasOwnProperty('inactiveAdminCount')) {
                obj['inactiveAdminCount'] = ApiClient.convertToType(data['inactiveAdminCount'], 'Number');
            }
            if (data.hasOwnProperty('inactiveDocMakerCount')) {
                obj['inactiveDocMakerCount'] = ApiClient.convertToType(data['inactiveDocMakerCount'], 'Number');
            }
            if (data.hasOwnProperty('inactiveEditorCount')) {
                obj['inactiveEditorCount'] = ApiClient.convertToType(data['inactiveEditorCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    * @member {Number} activeAdminCount
    */
    'activeAdminCount' = undefined;
    /**
    * Number of active Doc Makers.
    * @member {Number} activeDocMakerCount
    */
    'activeDocMakerCount' = undefined;
    /**
    * Number of active Editors.
    * @member {Number} activeEditorCount
    */
    'activeEditorCount' = undefined;
    /**
    * Number of inactive Admins.
    * @member {Number} inactiveAdminCount
    */
    'inactiveAdminCount' = undefined;
    /**
    * Number of inactive Doc Makers.
    * @member {Number} inactiveDocMakerCount
    */
    'inactiveDocMakerCount' = undefined;
    /**
    * Number of inactive Editor users.
    * @member {Number} inactiveEditorCount
    */
    'inactiveEditorCount' = undefined;


    /**
    * Returns Month corresponding to the data.
    * @return {String}
    */
    getMonth() {
        return this.month;
    ...
    /**
    * Sets Month corresponding to the data.
    * @param {String} month Month corresponding to the data.
    */
    setMonth(month) {
        this['month'] = month;
    }
    ...
    */
    ...
    /**
    * Sets Number of active Admins.
    * @param {Number} activeAdminCount Number of active Admins.
    */
    setActiveAdminCount(activeAdminCount) {
        this['activeAdminCount'] = activeAdminCount;
    }
    /**
    * Returns Number of active Doc Makers.
    * @return {Number}
    */
    getActiveDocMakerCount() {
        return this.activeDocMakerCount;
    }

    /**
    * Sets Number of active Doc Makers.
    * @param {Number} activeDocMakerCount Number of active Doc Makers.
    */
    setActiveDocMakerCount(activeDocMakerCount) {
        this['activeDocMakerCount'] = activeDocMakerCount;
    }
    /**
    ...
    * @return {Number}
    */
    getActiveEditorCount() {
        return this.activeEditorCount;
    }

    /**
    * Sets Number of active Editors.
    * @param {Number} activeEditorCount Number of active Editors.
    */
    setActiveEditorCount(activeEditorCount) {
        this['activeEditorCount'] = activeEditorCount;
    }
    /**
    * Returns Number of inactive Admins.
    * @return {Number}
    */
    getInactiveAdminCount() {
        return this.inactiveAdminCount;
    }

    /**
    * Sets Number of inactive Admins.
    * @param {Number} inactiveAdminCount Number of inactive Admins.
    */
    setInactiveAdminCount(inactiveAdminCount) {
        this['inactiveAdminCount'] = inactiveAdminCount;
    }
    /**
    * Returns Number of inactive Doc Makers.
    * @return {Number}
    */
    getInactiveDocMakerCount() {
        return this.inactiveDocMakerCount;
    }

    /**
    * Sets Number of inactive Doc Makers.
    * @param {Number} inactiveDocMakerCount Number of inactive Doc Makers.
    */
    setInactiveDocMakerCount(inactiveDocMakerCount) {
        this['inactiveDocMakerCount'] = inactiveDocMakerCount;
    }
    /**
    * Returns Number of inactive Editor users.
    * @return {Number}
    */
    getInactiveEditorCount() {
        return this.inactiveEditorCount;
    }

    /**
    * Sets Number of inactive Editor users.
    * @param {Number} inactiveEditorCount Number of inactive Editor users.
    */
    setInactiveEditorCount(inactiveEditorCount) {
        this['inactiveEditorCount'] = inactiveEditorCount;
    }
