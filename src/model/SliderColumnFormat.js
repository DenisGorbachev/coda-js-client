...
/**
* The SliderColumnFormat model module.
* @module model/SliderColumnFormat
* @version 1.2.0
*/
export default class SliderColumnFormat {
    /**
    * Constructs a new <code>SliderColumnFormat</code>.
    * Format of a numeric column that renders as a slider.
    * @alias module:model/SliderColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>SliderColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SliderColumnFormat} obj Optional instance to populate.
    * @return {module:model/SliderColumnFormat} The populated <code>SliderColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SliderColumnFormat();
            
            SimpleColumnFormat.constructFromObject(data, obj);
            
            if (data.hasOwnProperty('minimum')) {
                obj['minimum'] = ApiClient.convertToType(data['minimum'], ModelObject);
            }
            if (data.hasOwnProperty('maximum')) {
                obj['maximum'] = ApiClient.convertToType(data['maximum'], ModelObject);
            }
            if (data.hasOwnProperty('step')) {
                obj['step'] = ApiClient.convertToType(data['step'], ModelObject);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/ModelObject} minimum
    */
    'minimum' = undefined;
    /**
    * @member {module:model/ModelObject} maximum
    */
    'maximum' = undefined;
    /**
    * @member {module:model/ModelObject} step
    */
    'step' = undefined;
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} minimum
    */
    setMinimum(minimum) {
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} maximum
    */
    setMaximum(maximum) {
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} step
    */
    setStep(step) {
        this['step'] = step;
    }
