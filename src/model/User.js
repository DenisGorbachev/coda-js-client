...
export default class User {
    ...
    * @param loginId {String} Email address of the user.
    * @param type {module:model/User.TypeEnum} The type of this resource.
    * @param scoped {Boolean} True if the token used to make this request has restricted/scoped access to the API.
    * @param tokenName {String} Returns the name of the token used for this request.
    * @param href {String} API link to the user.
    * @param workspace {module:model/WorkspaceReference} 
    */

    constructor(name, loginId, type, scoped, tokenName, href, workspace) {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pictureLink')) {
                obj['pictureLink'] = ApiClient.convertToType(data['pictureLink'], 'String');
            }
            if (data.hasOwnProperty('workspace')) {
                obj['workspace'] = WorkspaceReference.constructFromObject(data['workspace']);
            }
        }
        return obj;
    }
    ...
    * @member {String} pictureLink
    */
    'pictureLink' = undefined;
    /**
    * @member {module:model/WorkspaceReference} workspace
    */
    'workspace' = undefined;
    ...
    * @param {String} loginId Email address of the user.
    */
    setLoginId(loginId) {
        this['loginId'] = loginId;
    }
    ...
    * @return {module:model/User.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/User.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns True if the token used to make this request has restricted/scoped access to the API.
    * @return {Boolean}
    */
    getScoped() {
        return this.scoped;
    ...
    /**
    * Sets True if the token used to make this request has restricted/scoped access to the API.
    * @param {Boolean} scoped True if the token used to make this request has restricted/scoped access to the API.
    */
    setScoped(scoped) {
        this['scoped'] = scoped;
    }
    /**
    * Returns Returns the name of the token used for this request.
    * @return {String}
    */
    getTokenName() {
    ...
    /**
    * Sets Returns the name of the token used for this request.
    * @param {String} tokenName Returns the name of the token used for this request.
    */
    setTokenName(tokenName) {
        this['tokenName'] = tokenName;
    }
    /**
    * Returns API link to the user.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the user.
    * @param {String} href API link to the user.
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * Returns Browser-friendly link to the user's avatar image.
    * @return {String}
    */
    getPictureLink() {
    ...
    /**
    * Sets Browser-friendly link to the user's avatar image.
    * @param {String} pictureLink Browser-friendly link to the user's avatar image.
    */
    setPictureLink(pictureLink) {
        this['pictureLink'] = pictureLink;
    }
    /**
    * @return {module:model/WorkspaceReference}
    */
    getWorkspace() {
    ...
    /**
    * @param {module:model/WorkspaceReference} workspace
    */
