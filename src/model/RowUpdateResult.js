...
/**
* The RowUpdateResult model module.
* @module model/RowUpdateResult
* @version 1.2.0
*/
export default class RowUpdateResult {
    /**
    * Constructs a new <code>RowUpdateResult</code>.
    * The result of a row update.
    * @alias module:model/RowUpdateResult
    * @class
    * @extends module:model/DocumentMutateResponse
    * @param requestId {} An arbitrary unique identifier for this request.
    * @param id {} ID of the updated row.
    */
    ...
    /**
    * Constructs a <code>RowUpdateResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowUpdateResult} obj Optional instance to populate.
    * @return {module:model/RowUpdateResult} The populated <code>RowUpdateResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowUpdateResult();
    ...
    */
    ...
    /**
    * Sets ID of the updated row.
    * @param {String} id ID of the updated row.
    */
    setId(id) {
        this['id'] = id;
    }
