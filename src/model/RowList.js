...
import NextSyncToken from './NextSyncToken';
import Row from './Row';

/**
* The RowList model module.
* @module model/RowList
* @version 1.2.0
*/
export default class RowList {
    /**
    * Constructs a new <code>RowList</code>.
    * List of rows.
    * @alias module:model/RowList
    * @class
    * @param items {Array.<module:model/Row>} 
    */
    ...
    /**
    * Constructs a <code>RowList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowList} obj Optional instance to populate.
    * @return {module:model/RowList} The populated <code>RowList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Row]);
            }
            if (data.hasOwnProperty('href')) {
                obj['href'] = ApiClient.convertToType(data['href'], 'String');
            }
            if (data.hasOwnProperty('nextPageToken')) {
                obj['nextPageToken'] = NextPageToken.constructFromObject(data['nextPageToken']);
            }
            if (data.hasOwnProperty('nextPageLink')) {
                obj['nextPageLink'] = ApiClient.convertToType(data['nextPageLink'], ModelObject);
            }
            if (data.hasOwnProperty('nextSyncToken')) {
                obj['nextSyncToken'] = NextSyncToken.constructFromObject(data['nextSyncToken']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/Row>} items
    */
    'items' = undefined;
    /**
    ...
    */
    'href' = undefined;
    /**
    * @member {module:model/NextPageToken} nextPageToken
    */
    'nextPageToken' = undefined;
    /**
    * @member {module:model/ModelObject} nextPageLink
    */
    'nextPageLink' = undefined;
    /**
    * @member {module:model/NextSyncToken} nextSyncToken
    */
    'nextSyncToken' = undefined;


    /**
    * @return {Array.<module:model/Row>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/Row>} items
    */
    setItems(items) {
        this['items'] = items;
    }
    /**
    * Returns API link to these results
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to these results
    * @param {String} href API link to these results
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * @return {module:model/NextPageToken}
    */
    getNextPageToken() {
    ...
    /**
    * @param {module:model/NextPageToken} nextPageToken
    */
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} nextPageLink
    */
    setNextPageLink(nextPageLink) {
        this['nextPageLink'] = nextPageLink;
    }
    /**
    * @return {module:model/NextSyncToken}
    */
    getNextSyncToken() {
    ...
    /**
    * @param {module:model/NextSyncToken} nextSyncToken
    */
