...
/**
* The ControlList model module.
* @module model/ControlList
* @version 1.2.0
*/
export default class ControlList {
    /**
    * Constructs a new <code>ControlList</code>.
    * List of controls.
    * @alias module:model/ControlList
    * @class
    * @param items {Array.<module:model/ControlReference>} 
    */
    ...
    /**
    * Constructs a <code>ControlList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ControlList} obj Optional instance to populate.
    * @return {module:model/ControlList} The populated <code>ControlList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ControlList();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ControlReference]);
            }
    ...
    /**
    * @member {Array.<module:model/ControlReference>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/ControlReference>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/ControlReference>} items
    */
    setItems(items) {
        this['items'] = items;
    }
