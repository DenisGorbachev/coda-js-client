...
/**
* Enum class ColumnFormatType.
* @enum {}
* @readonly
*/
export default class ColumnFormatType {
        /**
         * value: "text"
         * @const
         */
    ...
    /**
    * Returns a <code>ColumnFormatType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ColumnFormatType} The enum <code>ColumnFormatType</code> value.
    */
