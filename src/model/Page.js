...
export default class Page {
    ...
    * @param type {module:model/Page.TypeEnum} The type of this resource.
    * @param href {String} API link to the page.
    * @param browserLink {String} Browser-friendly link to the page.
    * @param name {String} Name of the page.
    * @param children {Array.<module:model/PageReference>} 
    */

    constructor(id, type, href, browserLink, name, children) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('children')) {
                obj['children'] = ApiClient.convertToType(data['children'], [PageReference]);
            }
        }
        return obj;
    }
    ...
    */
    'parent' = undefined;
    /**
    * @member {Array.<module:model/PageReference>} children
    */
    'children' = undefined;
    ...
    * @return {module:model/Page.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/Page.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns API link to the page.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the page.
    * @param {String} href API link to the page.
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * Returns Browser-friendly link to the page.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Browser-friendly link to the page.
    * @param {String} browserLink Browser-friendly link to the page.
    */
    ...
    */
    ...
    /**
    * @param {module:model/Image} image
    */
    setImage(image) {
        this['image'] = image;
    }
    ...
    */
    ...
    /**
    * @return {Array.<module:model/PageReference>}
    */
    getChildren() {
    ...
    /**
    * @param {Array.<module:model/PageReference>} children
    */
