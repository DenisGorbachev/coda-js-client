...
/**
* The PackWorkspacePrincipal model module.
* @module model/PackWorkspacePrincipal
* @version 1.2.0
*/
export default class PackWorkspacePrincipal {
    /**
    * Constructs a new <code>PackWorkspacePrincipal</code>.
    * @alias module:model/PackWorkspacePrincipal
    * @class
    * @param type {module:model/PackWorkspacePrincipal.TypeEnum} 
    * @param workspaceId {String} 
    */

    constructor(type, workspaceId) {
        
        OneOfPackPrincipal.call(this);
        this['type'] = type;
    ...
    /**
    * Constructs a <code>PackWorkspacePrincipal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackWorkspacePrincipal} obj Optional instance to populate.
    * @return {module:model/PackWorkspacePrincipal} The populated <code>PackWorkspacePrincipal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackWorkspacePrincipal();
    ...
    /**
    * @member {module:model/PackWorkspacePrincipal.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    */
    ...
    // Implement OneOfPackPrincipal interface:
    
    /**
    * @return {module:model/PackWorkspacePrincipal.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    /**
    * @param {module:model/PackWorkspacePrincipal.TypeEnum} type
    */
    setType(type) {
        this['type'] = type;
    }
