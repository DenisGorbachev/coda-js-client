...
import ApiLinkResolvedResource from './ApiLinkResolvedResource';

/**
* The ApiLink model module.
* @module model/ApiLink
* @version 1.2.0
*/
export default class ApiLink {
    ...
    * @alias module:model/ApiLink
    * @class
    * @param type {module:model/ApiLink.TypeEnum} The type of this resource.
    * @param href {String} Self link to this query.
    * @param resource {module:model/ApiLinkResolvedResource} 
    */

    constructor(type, href, resource) {
    ...
    * @param {module:model/ApiLink} obj Optional instance to populate.
    * @return {module:model/ApiLink} The populated <code>ApiLink</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resource')) {
                obj['resource'] = ApiLinkResolvedResource.constructFromObject(data['resource']);
            }
        }
        return obj;
    }
    ...
    * @member {module:model/ApiLink.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    */
    ...
    /**
    * @member {module:model/ApiLinkResolvedResource} resource
    */
    'resource' = undefined;
    ...
    * @return {module:model/ApiLink.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/ApiLink.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns Self link to this query.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets Self link to this query.
    * @param {String} href Self link to this query.
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * Returns Canonical browser-friendly link to the resolved resource.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Canonical browser-friendly link to the resolved resource.
    * @param {String} browserLink Canonical browser-friendly link to the resolved resource.
    */
    setBrowserLink(browserLink) {
        this['browserLink'] = browserLink;
    }
    /**
    * @return {module:model/ApiLinkResolvedResource}
    */
    getResource() {
    ...
    /**
    * @param {module:model/ApiLinkResolvedResource} resource
    */
