...
import DocAnalyticsItem from './DocAnalyticsItem';
import ModelObject from './ModelObject';
import NextPageToken from './NextPageToken';

/**
* The DocAnalyticsCollection model module.
* @module model/DocAnalyticsCollection
* @version 1.2.0
*/
export default class DocAnalyticsCollection {
    /**
    * Constructs a new <code>DocAnalyticsCollection</code>.
    * List of analytics for Coda docs over a date range.
    * @alias module:model/DocAnalyticsCollection
    * @class
    * @param items {Array.<module:model/DocAnalyticsItem>} 
    */
    ...
    /**
    * Constructs a <code>DocAnalyticsCollection</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocAnalyticsCollection} obj Optional instance to populate.
    * @return {module:model/DocAnalyticsCollection} The populated <code>DocAnalyticsCollection</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocAnalyticsCollection();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [DocAnalyticsItem]);
            }
    ...
    /**
    * @member {Array.<module:model/DocAnalyticsItem>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/DocAnalyticsItem>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/DocAnalyticsItem>} items
    */
    setItems(items) {
        this['items'] = items;
    }
