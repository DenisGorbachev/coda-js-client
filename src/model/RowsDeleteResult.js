...
/**
* The RowsDeleteResult model module.
* @module model/RowsDeleteResult
* @version 1.2.0
*/
export default class RowsDeleteResult {
    /**
    * Constructs a new <code>RowsDeleteResult</code>.
    * The result of a rows delete operation.
    * @alias module:model/RowsDeleteResult
    * @class
    * @extends module:model/DocumentMutateResponse
    * @param requestId {} An arbitrary unique identifier for this request.
    * @param rowIds {} Row IDs to delete.
    */

    constructor(requestId, rowIds) {
    ...
    /**
    * Constructs a <code>RowsDeleteResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowsDeleteResult} obj Optional instance to populate.
    * @return {module:model/RowsDeleteResult} The populated <code>RowsDeleteResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowsDeleteResult();
            
            DocumentMutateResponse.constructFromObject(data, obj);
            
            if (data.hasOwnProperty('rowIds')) {
                obj['rowIds'] = ApiClient.convertToType(data['rowIds'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
    * Row IDs to delete.
    * @member {Array.<String>} rowIds
    */
    'rowIds' = undefined;


    /**
    * Returns Row IDs to delete.
    * @return {Array.<String>}
    */
    getRowIds() {
        return this.rowIds;
