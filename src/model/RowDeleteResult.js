...
/**
* The RowDeleteResult model module.
* @module model/RowDeleteResult
* @version 1.2.0
*/
export default class RowDeleteResult {
    /**
    * Constructs a new <code>RowDeleteResult</code>.
    * The result of a row deletion.
    * @alias module:model/RowDeleteResult
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>RowDeleteResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowDeleteResult} obj Optional instance to populate.
    * @return {module:model/RowDeleteResult} The populated <code>RowDeleteResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowDeleteResult();
    ...
    */
    ...
    /**
    * Returns ID of the row to be deleted.
    * @return {String}
    */
    getId() {
        return this.id;
    ...
    /**
    * Sets ID of the row to be deleted.
