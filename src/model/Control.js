...
export default class Control {
    ...
    * @param type {module:model/Control.TypeEnum} The type of this resource.
    * @param href {String} API link to the control.
    * @param name {String} Name of the control.
    * @param controlType {module:model/ControlType} 
    * @param value {module:model/Value} 
    */

    constructor(id, type, href, name, controlType, value) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('controlType')) {
                obj['controlType'] = ControlType.constructFromObject(data['controlType']);
            }
    ...
    * @member {module:model/Control.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    */
    'parent' = undefined;
    /**
    * @member {module:model/ControlType} controlType
    */
    ...
    * @return {module:model/Control.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/Control.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    ...
    */
    ...
    /**
    * @return {module:model/ControlType}
    */
    getControlType() {
    ...
    /**
    * @param {module:model/ControlType} controlType
    */
    setControlType(controlType) {
        this['controlType'] = controlType;
    }
    /**
    * @return {module:model/Value}
    */
    getValue() {
        return this.value;
    }
