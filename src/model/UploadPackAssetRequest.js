...
/**
* The UploadPackAssetRequest model module.
* @module model/UploadPackAssetRequest
* @version 1.2.0
*/
export default class UploadPackAssetRequest {
    /**
    * Constructs a new <code>UploadPackAssetRequest</code>.
    * Payload for a Pack asset upload.
    * @alias module:model/UploadPackAssetRequest
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>UploadPackAssetRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UploadPackAssetRequest} obj Optional instance to populate.
    * @return {module:model/UploadPackAssetRequest} The populated <code>UploadPackAssetRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadPackAssetRequest();
