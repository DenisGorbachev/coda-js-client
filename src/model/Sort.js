...
export default class Sort {
    ...
    * @class
    * @param column {module:model/ColumnReference} 
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('column')) {
                obj['column'] = ColumnReference.constructFromObject(data['column']);
            }
    ...
    /**
    * @member {module:model/ColumnReference} column
    */
    'column' = undefined;
    /**
    ...
    */
    ...
    /**
    * @param {module:model/ColumnReference} column
    */
    setColumn(column) {
        this['column'] = column;
    }
    /**
    * @return {module:model/SortDirection}
    */
    getDirection() {
    ...
    /**
    * @param {module:model/SortDirection} direction
    */
