...
export default class TableList {
    ...
    * @class
    * @param items {Array.<module:model/TableReference>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [TableReference]);
            }
    ...
    /**
    * @member {Array.<module:model/TableReference>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/TableReference>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/TableReference>} items
    */
    setItems(items) {
        this['items'] = items;
    }
