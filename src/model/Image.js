...
export default class Image {
    ...
    * @class
    * @param browserLink {String} Browser-friendly link to an image.
    */

    constructor(browserLink) {
    ...
    */
    ...
    /**
    * Returns Browser-friendly link to an image.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Browser-friendly link to an image.
    * @param {String} browserLink Browser-friendly link to an image.
    */
    ...
    */
    ...
    /**
    * Sets The height in pixels of the image.
