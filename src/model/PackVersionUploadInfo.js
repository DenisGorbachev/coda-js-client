...
/**
* The PackVersionUploadInfo model module.
* @module model/PackVersionUploadInfo
* @version 1.2.0
*/
export default class PackVersionUploadInfo {
    /**
    * Constructs a new <code>PackVersionUploadInfo</code>.
    * Information indicating where to upload the Pack version definition.
    * @alias module:model/PackVersionUploadInfo
    * @class
    * @param uploadUrl {String} A signed url to be used for uploading a Pack version definition.
    */
    ...
    /**
    * Constructs a <code>PackVersionUploadInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PackVersionUploadInfo} obj Optional instance to populate.
    * @return {module:model/PackVersionUploadInfo} The populated <code>PackVersionUploadInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackVersionUploadInfo();
    ...
    */
    ...
    /**
    * Returns A signed url to be used for uploading a Pack version definition.
    * @return {String}
    */
    getUploadUrl() {
    ...
    /**
    * Sets A signed url to be used for uploading a Pack version definition.
    * @param {String} uploadUrl A signed url to be used for uploading a Pack version definition.
    */
