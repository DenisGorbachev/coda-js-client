...
/**
* The PageReference model module.
* @module model/PageReference
* @version 1.2.0
*/
export default class PageReference {
    /**
    * Constructs a new <code>PageReference</code>.
    * Reference to a page.
    * @alias module:model/PageReference
    * @class
    * @param id {String} ID of the page.
    * @param type {module:model/PageReference.TypeEnum} The type of this resource.
    ...
    */
    ...
    constructor(id, type, href, browserLink, name) {
    ...
    /**
    * Constructs a <code>PageReference</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PageReference} obj Optional instance to populate.
    * @return {module:model/PageReference} The populated <code>PageReference</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageReference();
    ...
    * @member {module:model/PageReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/PageReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/PageReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
