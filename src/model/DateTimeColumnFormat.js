...
/**
* The DateTimeColumnFormat model module.
* @module model/DateTimeColumnFormat
* @version 1.2.0
*/
export default class DateTimeColumnFormat {
    /**
    * Constructs a new <code>DateTimeColumnFormat</code>.
    * Format of a date column.
    * @alias module:model/DateTimeColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>DateTimeColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DateTimeColumnFormat} obj Optional instance to populate.
    * @return {module:model/DateTimeColumnFormat} The populated <code>DateTimeColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateTimeColumnFormat();
    ...
    */
    ...
    /**
    * Returns A format string using Moment syntax: https://momentjs.com/docs/#/displaying/
    * @return {String}
    */
    getDateFormat() {
    ...
    /**
    * Sets A format string using Moment syntax: https://momentjs.com/docs/#/displaying/
    * @param {String} dateFormat A format string using Moment syntax: https://momentjs.com/docs/#/displaying/
    */
    ...
    */
    ...
    /**
    * Sets A format string using Moment syntax: https://momentjs.com/docs/#/displaying/
    * @param {String} timeFormat A format string using Moment syntax: https://momentjs.com/docs/#/displaying/
    */
