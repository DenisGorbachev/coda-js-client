...
/**
* The AnyonePrincipal model module.
* @module model/AnyonePrincipal
* @version 1.2.0
*/
export default class AnyonePrincipal {
    /**
    * Constructs a new <code>AnyonePrincipal</code>.
    * @alias module:model/AnyonePrincipal
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>AnyonePrincipal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AnyonePrincipal} obj Optional instance to populate.
    * @return {module:model/AnyonePrincipal} The populated <code>AnyonePrincipal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnyonePrincipal();
