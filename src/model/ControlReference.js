...
/**
* The ControlReference model module.
* @module model/ControlReference
* @version 1.2.0
*/
export default class ControlReference {
    /**
    * Constructs a new <code>ControlReference</code>.
    * Reference to a control.
    * @alias module:model/ControlReference
    * @class
    * @param id {String} ID of the control.
    * @param type {module:model/ControlReference.TypeEnum} The type of this resource.
    * @param href {String} API link to the control.
    ...
    */
    ...
    /**
    * Constructs a <code>ControlReference</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ControlReference} obj Optional instance to populate.
    * @return {module:model/ControlReference} The populated <code>ControlReference</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ControlReference();
    ...
    * @member {module:model/ControlReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/ControlReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/ControlReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns API link to the control.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the control.
    * @param {String} href API link to the control.
    */
    setHref(href) {
        this['href'] = href;
    }
