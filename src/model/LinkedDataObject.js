...
/**
* The LinkedDataObject model module.
* @module model/LinkedDataObject
* @version 1.2.0
*/
export default class LinkedDataObject {
    /**
    * Constructs a new <code>LinkedDataObject</code>.
    * Base type for a JSON-LD (Linked Data) object.
    * @alias module:model/LinkedDataObject
    * @class
    * @param context {String} A url describing the schema context for this object, typically \"http://schema.org/\".
    * @param type {module:model/LinkedDataType} 
    */
    ...
    /**
    * Constructs a <code>LinkedDataObject</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/LinkedDataObject} obj Optional instance to populate.
    * @return {module:model/LinkedDataObject} The populated <code>LinkedDataObject</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinkedDataObject();
            ...
            if (data.hasOwnProperty('@type')) {
                obj['@type'] = LinkedDataType.constructFromObject(data['@type']);
            }
    ...
    */
    '@context' = undefined;
    /**
    * @member {module:model/LinkedDataType} @type
    */
    '@type' = undefined;
    /**
    ...
    */
    ...
    /**
    * Returns A url describing the schema context for this object, typically \"http://schema.org/\".
    * @return {String}
    */
    getContext() {
        return this.@context;
    ...
    /**
    * Sets A url describing the schema context for this object, typically \"http://schema.org/\".
    * @param {String} context A url describing the schema context for this object, typically \"http://schema.org/\".
    */
    setContext(context) {
        this['@context'] = context;
    }
    /**
    * @return {module:model/LinkedDataType}
    */
    getType() {
        return this.@type;
    }
    ...
    /**
    * @param {module:model/LinkedDataType} type
    */
    setType(type) {
        this['@type'] = type;
    }
    /**
    * Returns An identifier of additional type info specific to Coda that may not be present in a schema.org taxonomy, 
    * @return {String}
    */
    getAdditionalType() {
    ...
    /**
    * Sets An identifier of additional type info specific to Coda that may not be present in a schema.org taxonomy, 
    * @param {String} additionalType An identifier of additional type info specific to Coda that may not be present in a schema.org taxonomy, 
    */
