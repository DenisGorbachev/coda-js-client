...
export default class Icon {
    ...
    * @param type {String} MIME type of the icon
    * @param browserLink {String} Browser-friendly link to an icon.
    */

    constructor(name, type, browserLink) {
    ...
    */
    ...
    /**
    * Sets MIME type of the icon
    * @param {String} type MIME type of the icon
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns Browser-friendly link to an icon.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Browser-friendly link to an icon.
    * @param {String} browserLink Browser-friendly link to an icon.
    */
