...
/**
* The RowsUpsert model module.
* @module model/RowsUpsert
* @version 1.2.0
*/
export default class RowsUpsert {
    /**
    * Constructs a new <code>RowsUpsert</code>.
    * Payload for upserting rows in a table.
    * @alias module:model/RowsUpsert
    * @class
    * @param rows {Array.<module:model/RowEdit>} 
    */
    ...
    /**
    * Constructs a <code>RowsUpsert</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowsUpsert} obj Optional instance to populate.
    * @return {module:model/RowsUpsert} The populated <code>RowsUpsert</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowsUpsert();
                        
            
            if (data.hasOwnProperty('rows')) {
                obj['rows'] = ApiClient.convertToType(data['rows'], [RowEdit]);
            }
            if (data.hasOwnProperty('keyColumns')) {
                obj['keyColumns'] = ApiClient.convertToType(data['keyColumns'], ['String']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @param {Array.<module:model/RowEdit>} rows
    */
    setRows(rows) {
        this['rows'] = rows;
    }
    /**
    * Returns Optional column IDs, URLs, or names (fragile and discouraged), specifying columns to be used as upsert keys. 
    * @return {Array.<String>}
    */
    getKeyColumns() {
    ...
    /**
    * Sets Optional column IDs, URLs, or names (fragile and discouraged), specifying columns to be used as upsert keys. 
    * @param {Array.<String>} keyColumns Optional column IDs, URLs, or names (fragile and discouraged), specifying columns to be used as upsert keys. 
    */
