...
/**
* The ColumnDetail model module.
* @module model/ColumnDetail
* @version 1.2.0
*/
export default class ColumnDetail {
    /**
    * Constructs a new <code>ColumnDetail</code>.
    * Info about a column.
    * @alias module:model/ColumnDetail
    * @class
    * @param id {String} ID of the column.
    * @param type {module:model/ColumnDetail.TypeEnum} The type of this resource.
    * @param href {String} API link to the column.
    * @param name {String} Name of the column.
    * @param format {module:model/ColumnFormat} 
    * @param parent {module:model/TableReference} 
    */

    constructor(id, type, href, name, format, parent) {
    ...
    /**
    * Constructs a <code>ColumnDetail</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ColumnDetail} obj Optional instance to populate.
    * @return {module:model/ColumnDetail} The populated <code>ColumnDetail</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ColumnDetail();
            ...
            if (data.hasOwnProperty('format')) {
                obj['format'] = ColumnFormat.constructFromObject(data['format']);
            }
    ...
    * @member {module:model/ColumnDetail.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    */
    ...
    /**
    * @member {module:model/ColumnFormat} format
    */
    'format' = undefined;
    /**
    ...
    * @return {module:model/ColumnDetail.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/ColumnDetail.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns API link to the column.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the column.
    * @param {String} href API link to the column.
    */
    setHref(href) {
        this['href'] = href;
    }
    ...
    */
    ...
    /**
    * Returns Whether the column is the display column.
    * @return {Boolean}
    */
    getDisplay() {
        return this.display;
    ...
    /**
    * Sets Whether the column is the display column.
    * @param {Boolean} display Whether the column is the display column.
    */
    setDisplay(display) {
        this['display'] = display;
    }
    /**
    * Returns Whether the column has a formula set on it.
    * @return {Boolean}
    */
    getCalculated() {
    ...
    /**
    * Sets Whether the column has a formula set on it.
    * @param {Boolean} calculated Whether the column has a formula set on it.
    */
    setCalculated(calculated) {
        this['calculated'] = calculated;
    }
    /**
    * @return {module:model/ColumnFormat}
    */
    getFormat() {
        return this.format;
    }
    ...
    /**
    * @param {module:model/ColumnFormat} format
    */
    setFormat(format) {
        this['format'] = format;
    }
