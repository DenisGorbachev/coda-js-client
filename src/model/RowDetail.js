...
/**
* The RowDetail model module.
* @module model/RowDetail
* @version 1.2.0
*/
export default class RowDetail {
    /**
    * Constructs a new <code>RowDetail</code>.
    * Details about a row.
    * @alias module:model/RowDetail
    * @class
    * @param id {String} ID of the row.
    * @param type {module:model/RowDetail.TypeEnum} The type of this resource.
    * @param href {String} API link to the row.
    * @param name {String} The display name of the row, based on its identifying column.
    * @param index {Number} Index of the row within the table.
    * @param browserLink {String} Browser-friendly link to the row.
    * @param createdAt {Date} Timestamp for when the row was created.
    * @param updatedAt {Date} Timestamp for when the row was last modified.
    * @param values {Object.<String, module:model/CellValue>} Values for a specific row, represented as a hash of column IDs (or names with `useColumnNames`) to values. 
    * @param parent {module:model/TableReference} 
    */

    constructor(id, type, href, name, index, browserLink, createdAt, updatedAt, values, parent) {
    ...
    /**
    * Constructs a <code>RowDetail</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RowDetail} obj Optional instance to populate.
    * @return {module:model/RowDetail} The populated <code>RowDetail</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowDetail();
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], {'String': CellValue});
            }
            if (data.hasOwnProperty('parent')) {
                obj['parent'] = TableReference.constructFromObject(data['parent']);
            }
        }
        return obj;
    }
    ...
    * @member {module:model/RowDetail.TypeEnum} type
    */
    'type' = undefined;
    /**
    * API link to the row.
    ...
    * @member {Object.<String, module:model/CellValue>} values
    */
    'values' = undefined;
    /**
    * @member {module:model/TableReference} parent
    */
    'parent' = undefined;
    ...
    * @return {module:model/RowDetail.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/RowDetail.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns API link to the row.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the row.
    * @param {String} href API link to the row.
    */
    setHref(href) {
        this['href'] = href;
    }
    /**
    * Returns The display name of the row, based on its identifying column.
    * @return {String}
    */
    getName() {
        return this.name;
    ...
    /**
    * Sets The display name of the row, based on its identifying column.
    * @param {String} name The display name of the row, based on its identifying column.
    */
    setName(name) {
        this['name'] = name;
    }
    /**
    * Returns Index of the row within the table.
    * @return {Number}
    */
    getIndex() {
        return this.index;
    ...
    /**
    * Sets Index of the row within the table.
    * @param {Number} index Index of the row within the table.
    */
    setIndex(index) {
        this['index'] = index;
    }
    /**
    * Returns Browser-friendly link to the row.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Browser-friendly link to the row.
    * @param {String} browserLink Browser-friendly link to the row.
    */
    setBrowserLink(browserLink) {
        this['browserLink'] = browserLink;
    }
    /**
    * Returns Timestamp for when the row was created.
    * @return {Date}
    */
    getCreatedAt() {
    ...
    /**
    * Sets Timestamp for when the row was created.
    * @param {Date} createdAt Timestamp for when the row was created.
    */
    setCreatedAt(createdAt) {
        this['createdAt'] = createdAt;
    }
    /**
    * Returns Timestamp for when the row was last modified.
    * @return {Date}
    */
    getUpdatedAt() {
    ...
    /**
    * Sets Timestamp for when the row was last modified.
    * @param {Date} updatedAt Timestamp for when the row was last modified.
    */
    setUpdatedAt(updatedAt) {
        this['updatedAt'] = updatedAt;
    }
    /**
    * Returns Values for a specific row, represented as a hash of column IDs (or names with `useColumnNames`) to values. 
    * @return {Object.<String, module:model/CellValue>}
    */
    getValues() {
        return this.values;
    }
    ...
    /**
    * Sets Values for a specific row, represented as a hash of column IDs (or names with `useColumnNames`) to values. 
    * @param {Object.<String, module:model/CellValue>} values Values for a specific row, represented as a hash of column IDs (or names with `useColumnNames`) to values. 
    */
    setValues(values) {
        this['values'] = values;
    }
    /**
    * @return {module:model/TableReference}
    */
    getParent() {
        return this.parent;
    }
    ...
    /**
    * @param {module:model/TableReference} parent
    */
    setParent(parent) {
        this['parent'] = parent;
    }
