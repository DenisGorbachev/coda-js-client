...
/**
* The WorkspaceReference model module.
* @module model/WorkspaceReference
* @version 1.2.0
*/
export default class WorkspaceReference {
    /**
    * Constructs a new <code>WorkspaceReference</code>.
    * Reference to a Coda workspace.
    * @alias module:model/WorkspaceReference
    * @class
    * @param id {String} ID of the Coda workspace.
    * @param type {module:model/WorkspaceReference.TypeEnum} The type of this resource.
    * @param browserLink {String} Browser-friendly link to the Coda workspace.
    */

    constructor(id, type, browserLink) {
    ...
    /**
    * Constructs a <code>WorkspaceReference</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/WorkspaceReference} obj Optional instance to populate.
    * @return {module:model/WorkspaceReference} The populated <code>WorkspaceReference</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkspaceReference();
    ...
    * @member {module:model/WorkspaceReference.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    */
    ...
    /**
    * Returns ID of the Coda workspace.
    * @return {String}
    */
    getId() {
        return this.id;
    ...
    /**
    * Sets ID of the Coda workspace.
    * @param {String} id ID of the Coda workspace.
    */
    setId(id) {
        this['id'] = id;
    }
    ...
    * @return {module:model/WorkspaceReference.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/WorkspaceReference.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
    /**
    * Returns Browser-friendly link to the Coda workspace.
    * @return {String}
    */
    getBrowserLink() {
    ...
    /**
    * Sets Browser-friendly link to the Coda workspace.
    * @param {String} browserLink Browser-friendly link to the Coda workspace.
    */
