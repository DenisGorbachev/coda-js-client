...
import WorkspaceUserRole from './WorkspaceUserRole';
...
export default class WorkspaceUser {
    ...
    * @param role {module:model/WorkspaceUserRole} 
    * @param registeredAt {Date} Timestamp for when the user registered in this workspace
    * @param roleChangedAt {Date} Timestamp for when the user's role last changed in this workspace.
    */

    constructor(email, name, role, registeredAt, roleChangedAt) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('role')) {
                obj['role'] = WorkspaceUserRole.constructFromObject(data['role']);
            }
            ...
            if (data.hasOwnProperty('roleChangedAt')) {
                obj['roleChangedAt'] = ApiClient.convertToType(data['roleChangedAt'], 'Date');
            }
            if (data.hasOwnProperty('lastActiveAt')) {
                obj['lastActiveAt'] = ApiClient.convertToType(data['lastActiveAt'], 'Date');
            }
            if (data.hasOwnProperty('docsLastActiveAt')) {
                obj['docsLastActiveAt'] = ApiClient.convertToType(data['docsLastActiveAt'], 'Date');
            }
            if (data.hasOwnProperty('ownedDocIds')) {
                obj['ownedDocIds'] = ApiClient.convertToType(data['ownedDocIds'], ['String']);
            }
            if (data.hasOwnProperty('docCollaboratorCount')) {
                obj['docCollaboratorCount'] = ApiClient.convertToType(data['docCollaboratorCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    */
    'name' = undefined;
    /**
    * @member {module:model/WorkspaceUserRole} role
    */
    'role' = undefined;
    /**
    ...
    * @member {Date} docsLastActiveAt
    */
    'docsLastActiveAt' = undefined;
    /**
    * List of IDs of docs owned by the user.
    * @member {Array.<String>} ownedDocIds
    */
    'ownedDocIds' = undefined;
    /**
    * Number of collaborators that have interacted with docs owned by the user.
    * @member {Number} docCollaboratorCount
    */
    'docCollaboratorCount' = undefined;
    ...
    */
    ...
    /**
    * @return {module:model/WorkspaceUserRole}
    */
    getRole() {
        return this.role;
    }
    ...
    /**
    * @param {module:model/WorkspaceUserRole} role
    */
    setRole(role) {
        this['role'] = role;
    }
    /**
    * Returns Picture url of the user.
    * @return {String}
    */
    getPictureUrl() {
    ...
    /**
    * Sets Picture url of the user.
    * @param {String} pictureUrl Picture url of the user.
    */
    setPictureUrl(pictureUrl) {
        this['pictureUrl'] = pictureUrl;
    }
    /**
    * Returns Timestamp for when the user registered in this workspace
    * @return {Date}
    */
    getRegisteredAt() {
    ...
    /**
    * Sets Timestamp for when the user registered in this workspace
    * @param {Date} registeredAt Timestamp for when the user registered in this workspace
    */
    setRegisteredAt(registeredAt) {
        this['registeredAt'] = registeredAt;
    }
    /**
    * Returns Timestamp for when the user's role last changed in this workspace.
    * @return {Date}
    */
    getRoleChangedAt() {
    ...
    /**
    * Sets Timestamp for when the user's role last changed in this workspace.
    * @param {Date} roleChangedAt Timestamp for when the user's role last changed in this workspace.
    */
    setRoleChangedAt(roleChangedAt) {
        this['roleChangedAt'] = roleChangedAt;
    }
    /**
    * Returns Timestamp for when the user last took an action in this workspace.
    * @return {Date}
    */
    getLastActiveAt() {
    ...
    /**
    * Sets Timestamp for when the user last took an action in this workspace.
    * @param {Date} lastActiveAt Timestamp for when the user last took an action in this workspace.
    */
    setLastActiveAt(lastActiveAt) {
        this['lastActiveAt'] = lastActiveAt;
    }
    /**
    * Returns Timestamp for when someone last loaded a doc that the user owns in this workspace.
    * @return {Date}
    */
    getDocsLastActiveAt() {
        return this.docsLastActiveAt;
    }

    /**
    * Sets Timestamp for when someone last loaded a doc that the user owns in this workspace.
    * @param {Date} docsLastActiveAt Timestamp for when someone last loaded a doc that the user owns in this workspace.
    */
    setDocsLastActiveAt(docsLastActiveAt) {
        this['docsLastActiveAt'] = docsLastActiveAt;
    }
    /**
    * Returns List of IDs of docs owned by the user.
    * @return {Array.<String>}
    */
    getOwnedDocIds() {
        return this.ownedDocIds;
    }

    /**
    * Sets List of IDs of docs owned by the user.
    * @param {Array.<String>} ownedDocIds List of IDs of docs owned by the user.
    */
    setOwnedDocIds(ownedDocIds) {
        this['ownedDocIds'] = ownedDocIds;
    }
    /**
    * Returns Number of collaborators that have interacted with docs owned by the user.
    * @return {Number}
    */
    getDocCollaboratorCount() {
        return this.docCollaboratorCount;
    }

    /**
    * Sets Number of collaborators that have interacted with docs owned by the user.
    * @param {Number} docCollaboratorCount Number of collaborators that have interacted with docs owned by the user.
    */
    setDocCollaboratorCount(docCollaboratorCount) {
        this['docCollaboratorCount'] = docCollaboratorCount;
    }
