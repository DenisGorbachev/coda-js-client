...
/**
* The UpdatePackRequestOverallRateLimit model module.
* @module model/UpdatePackRequestOverallRateLimit
* @version 1.2.0
*/
export default class UpdatePackRequestOverallRateLimit {
    /**
    * Constructs a new <code>UpdatePackRequestOverallRateLimit</code>.
    * Rate limit in Pack settings.
    * @alias module:model/UpdatePackRequestOverallRateLimit
    * @class
    * @param intervalSeconds {Number} The rate limit interval in seconds.
    * @param operationsPerInterval {Number} The maximum number of Pack operations that can be performed in a given interval.
    */

    constructor(intervalSeconds, operationsPerInterval) {
        
        
        this['intervalSeconds'] = intervalSeconds;
        this['operationsPerInterval'] = operationsPerInterval;
        
    }

    /**
    * Constructs a <code>UpdatePackRequestOverallRateLimit</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UpdatePackRequestOverallRateLimit} obj Optional instance to populate.
    * @return {module:model/UpdatePackRequestOverallRateLimit} The populated <code>UpdatePackRequestOverallRateLimit</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePackRequestOverallRateLimit();
                        
            
            if (data.hasOwnProperty('intervalSeconds')) {
                obj['intervalSeconds'] = ApiClient.convertToType(data['intervalSeconds'], 'Number');
            }
            if (data.hasOwnProperty('operationsPerInterval')) {
                obj['operationsPerInterval'] = ApiClient.convertToType(data['operationsPerInterval'], 'Number');
            }
        }
        return obj;
    }
    ...
    * @member {Number} operationsPerInterval
    */
    'operationsPerInterval' = undefined;
    ...
    */
    ...
    /**
    * Sets The rate limit interval in seconds.
    * @param {Number} intervalSeconds The rate limit interval in seconds.
    */
    setIntervalSeconds(intervalSeconds) {
        this['intervalSeconds'] = intervalSeconds;
    }
    /**
    * Returns The maximum number of Pack operations that can be performed in a given interval.
    * @return {Number}
    */
    getOperationsPerInterval() {
        return this.operationsPerInterval;
    }

    /**
    * Sets The maximum number of Pack operations that can be performed in a given interval.
    * @param {Number} operationsPerInterval The maximum number of Pack operations that can be performed in a given interval.
    */
    setOperationsPerInterval(operationsPerInterval) {
        this['operationsPerInterval'] = operationsPerInterval;
    }
