...
/**
* The AllOfDocSourceDoc model module.
* @module model/AllOfDocSourceDoc
* @version 1.2.0
*/
export default class AllOfDocSourceDoc {
    /**
    * Constructs a new <code>AllOfDocSourceDoc</code>.
    * @alias module:model/AllOfDocSourceDoc
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>AllOfDocSourceDoc</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfDocSourceDoc} obj Optional instance to populate.
    * @return {module:model/AllOfDocSourceDoc} The populated <code>AllOfDocSourceDoc</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfDocSourceDoc();
    ...
    * @member {module:model/AllOfDocSourceDoc.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/AllOfDocSourceDoc.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/AllOfDocSourceDoc.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
