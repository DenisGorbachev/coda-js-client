...
/**
* The DocumentMutateResponse model module.
* @module model/DocumentMutateResponse
* @version 1.2.0
*/
export default class DocumentMutateResponse {
    /**
    * Constructs a new <code>DocumentMutateResponse</code>.
    * Base response type for an operation that mutates a document.
    * @alias module:model/DocumentMutateResponse
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>DocumentMutateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocumentMutateResponse} obj Optional instance to populate.
    * @return {module:model/DocumentMutateResponse} The populated <code>DocumentMutateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentMutateResponse();
