...
/**
* The DocCategory model module.
* @module model/DocCategory
* @version 1.2.0
*/
export default class DocCategory {
    /**
    * Constructs a new <code>DocCategory</code>.
    * The category applied to a doc.
    * @alias module:model/DocCategory
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>DocCategory</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocCategory} obj Optional instance to populate.
    * @return {module:model/DocCategory} The populated <code>DocCategory</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocCategory();
