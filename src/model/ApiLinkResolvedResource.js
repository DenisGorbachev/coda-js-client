...
/**
* The ApiLinkResolvedResource model module.
* @module model/ApiLinkResolvedResource
* @version 1.2.0
*/
export default class ApiLinkResolvedResource {
    /**
    * Constructs a new <code>ApiLinkResolvedResource</code>.
    * Reference to the resolved resource.
    * @alias module:model/ApiLinkResolvedResource
    * @class
    * @param type {module:model/Type} 
    * @param id {String} ID of the resolved resource.
    * @param href {String} API link to the resolved resource that can be queried to get further information.
    */

    constructor(type, id, href) {
    ...
    /**
    * Constructs a <code>ApiLinkResolvedResource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ApiLinkResolvedResource} obj Optional instance to populate.
    * @return {module:model/ApiLinkResolvedResource} The populated <code>ApiLinkResolvedResource</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiLinkResolvedResource();
    ...
    */
    ...
    /**
    * Returns ID of the resolved resource.
    * @return {String}
    */
    getId() {
        return this.id;
    ...
    /**
    * Sets ID of the resolved resource.
    * @param {String} id ID of the resolved resource.
    */
    setId(id) {
        this['id'] = id;
    }
    ...
    */
    ...
    /**
    * Returns API link to the resolved resource that can be queried to get further information.
    * @return {String}
    */
    getHref() {
        return this.href;
    ...
    /**
    * Sets API link to the resolved resource that can be queried to get further information.
    * @param {String} href API link to the resolved resource that can be queried to get further information.
    */
    setHref(href) {
        this['href'] = href;
    }
