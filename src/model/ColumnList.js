...
/**
* The ColumnList model module.
* @module model/ColumnList
* @version 1.2.0
*/
export default class ColumnList {
    /**
    * Constructs a new <code>ColumnList</code>.
    * List of columns.
    * @alias module:model/ColumnList
    * @class
    * @param items {Array.<module:model/Column>} 
    */
    ...
    /**
    * Constructs a <code>ColumnList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ColumnList} obj Optional instance to populate.
    * @return {module:model/ColumnList} The populated <code>ColumnList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ColumnList();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Column]);
            }
    ...
    /**
    * @member {Array.<module:model/Column>} items
    */
    'items' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {Array.<module:model/Column>}
    */
    getItems() {
        return this.items;
    }
    ...
    /**
    * @param {Array.<module:model/Column>} items
    */
    setItems(items) {
        this['items'] = items;
    }
