...
/**
* The DocAnalyticsItem model module.
* @module model/DocAnalyticsItem
* @version 1.2.0
*/
export default class DocAnalyticsItem {
    /**
    * Constructs a new <code>DocAnalyticsItem</code>.
    * Analytics data for a Coda doc.
    * @alias module:model/DocAnalyticsItem
    * @class
    * @param doc {module:model/ModelObject} 
    * @param _date {Date} Date of the analytics data.
    * @param views {Number} Number of times the doc was viewed.
    * @param copies {Number} Number of times the doc was copied.
    * @param likes {Number} Number of times the doc was liked.
    * @param sessionsMobile {Number} Number of unique visitors to this doc from a mobile device.
    * @param sessionsDesktop {Number} Number of unique visitors to this doc from a desktop device.
    * @param sessionsOther {Number} Number of unique visitors to this doc from an unknown device type.
    */

    constructor(doc, _date, views, copies, likes, sessionsMobile, sessionsDesktop, sessionsOther) {
        ...
        this['sessionsDesktop'] = sessionsDesktop;
        this['sessionsOther'] = sessionsOther;
        
    }

    /**
    * Constructs a <code>DocAnalyticsItem</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocAnalyticsItem} obj Optional instance to populate.
    * @return {module:model/DocAnalyticsItem} The populated <code>DocAnalyticsItem</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocAnalyticsItem();
                        
            
            if (data.hasOwnProperty('doc')) {
                obj['doc'] = ApiClient.convertToType(data['doc'], ModelObject);
            }
            ...
            if (data.hasOwnProperty('sessionsMobile')) {
                obj['sessionsMobile'] = ApiClient.convertToType(data['sessionsMobile'], 'Number');
            }
            if (data.hasOwnProperty('sessionsDesktop')) {
                obj['sessionsDesktop'] = ApiClient.convertToType(data['sessionsDesktop'], 'Number');
            }
            if (data.hasOwnProperty('sessionsOther')) {
                obj['sessionsOther'] = ApiClient.convertToType(data['sessionsOther'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/ModelObject} doc
    */
    'doc' = undefined;
    /**
    ...
    * @member {Number} sessionsMobile
    */
    'sessionsMobile' = undefined;
    /**
    * Number of unique visitors to this doc from a desktop device.
    * @member {Number} sessionsDesktop
    */
    'sessionsDesktop' = undefined;
    /**
    * Number of unique visitors to this doc from an unknown device type.
    * @member {Number} sessionsOther
    */
    'sessionsOther' = undefined;
    ...
    */
    ...
    /**
    * @param {module:model/ModelObject} doc
    */
    setDoc(doc) {
        this['doc'] = doc;
    }
    /**
    * Returns Date of the analytics data.
    * @return {Date}
    */
    getDate() {
        return this.date;
    ...
    /**
    * Sets Date of the analytics data.
    * @param {Date} _date Date of the analytics data.
    */
    setDate(_date) {
        this['date'] = _date;
    }
    /**
    * Returns Number of times the doc was viewed.
    * @return {Number}
    */
    getViews() {
        return this.views;
    ...
    /**
    * Sets Number of times the doc was viewed.
    * @param {Number} views Number of times the doc was viewed.
    */
    setViews(views) {
        this['views'] = views;
    }
    /**
    * Returns Number of times the doc was copied.
    * @return {Number}
    */
    getCopies() {
        return this.copies;
    ...
    /**
    * Sets Number of times the doc was copied.
    * @param {Number} copies Number of times the doc was copied.
    */
    setCopies(copies) {
        this['copies'] = copies;
    }
    /**
    * Returns Number of times the doc was liked.
    * @return {Number}
    */
    getLikes() {
        return this.likes;
    ...
    /**
    * Sets Number of times the doc was liked.
    * @param {Number} likes Number of times the doc was liked.
    */
    setLikes(likes) {
        this['likes'] = likes;
    }
    /**
    * Returns Number of unique visitors to this doc from a mobile device.
    * @return {Number}
    */
    getSessionsMobile() {
    ...
    /**
    * Sets Number of unique visitors to this doc from a mobile device.
    * @param {Number} sessionsMobile Number of unique visitors to this doc from a mobile device.
    */
    setSessionsMobile(sessionsMobile) {
        this['sessionsMobile'] = sessionsMobile;
    }
    /**
    * Returns Number of unique visitors to this doc from a desktop device.
    * @return {Number}
    */
    getSessionsDesktop() {
        return this.sessionsDesktop;
    }

    /**
    * Sets Number of unique visitors to this doc from a desktop device.
    * @param {Number} sessionsDesktop Number of unique visitors to this doc from a desktop device.
    */
    setSessionsDesktop(sessionsDesktop) {
        this['sessionsDesktop'] = sessionsDesktop;
    }
    /**
    * Returns Number of unique visitors to this doc from an unknown device type.
    * @return {Number}
    */
    getSessionsOther() {
        return this.sessionsOther;
    }

    /**
    * Sets Number of unique visitors to this doc from an unknown device type.
    * @param {Number} sessionsOther Number of unique visitors to this doc from an unknown device type.
    */
    setSessionsOther(sessionsOther) {
        this['sessionsOther'] = sessionsOther;
    }
