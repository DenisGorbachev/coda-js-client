...
import EmailDisplayType from './EmailDisplayType';
import SimpleColumnFormat from './SimpleColumnFormat';

/**
* The EmailColumnFormat model module.
* @module model/EmailColumnFormat
* @version 1.2.0
*/
export default class EmailColumnFormat {
    /**
    * Constructs a new <code>EmailColumnFormat</code>.
    * Format of an email column.
    * @alias module:model/EmailColumnFormat
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>EmailColumnFormat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/EmailColumnFormat} obj Optional instance to populate.
    * @return {module:model/EmailColumnFormat} The populated <code>EmailColumnFormat</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailColumnFormat();
            
            SimpleColumnFormat.constructFromObject(data, obj);
            
            if (data.hasOwnProperty('display')) {
                obj['display'] = EmailDisplayType.constructFromObject(data['display']);
            }
    ...
    /**
    * @member {module:model/EmailDisplayType} display
    */
    'display' = undefined;
    /**
    ...
    */
    ...
    /**
    * @return {module:model/EmailDisplayType}
    */
    getDisplay() {
        return this.display;
    }
    ...
    /**
    * @param {module:model/EmailDisplayType} display
    */
    setDisplay(display) {
