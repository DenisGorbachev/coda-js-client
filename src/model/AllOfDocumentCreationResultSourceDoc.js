...
/**
* The AllOfDocumentCreationResultSourceDoc model module.
* @module model/AllOfDocumentCreationResultSourceDoc
* @version 1.2.0
*/
export default class AllOfDocumentCreationResultSourceDoc {
    /**
    * Constructs a new <code>AllOfDocumentCreationResultSourceDoc</code>.
    * @alias module:model/AllOfDocumentCreationResultSourceDoc
    * @class
    * @param id {} ID of the Coda doc.
    * @param type {} The type of this resource.
    * @param href {} API link to the Coda doc.
    * @param browserLink {} Browser-friendly link to the Coda doc.
    */

    constructor(id, type, href, browserLink) {
    ...
    /**
    * Constructs a <code>AllOfDocumentCreationResultSourceDoc</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfDocumentCreationResultSourceDoc} obj Optional instance to populate.
    * @return {module:model/AllOfDocumentCreationResultSourceDoc} The populated <code>AllOfDocumentCreationResultSourceDoc</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfDocumentCreationResultSourceDoc();
    ...
    * @member {module:model/AllOfDocumentCreationResultSourceDoc.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @return {module:model/AllOfDocumentCreationResultSourceDoc.TypeEnum}
    */
    getType() {
        return this.type;
    }
    ...
    * @param {module:model/AllOfDocumentCreationResultSourceDoc.TypeEnum} type The type of this resource.
    */
    setType(type) {
        this['type'] = type;
    }
