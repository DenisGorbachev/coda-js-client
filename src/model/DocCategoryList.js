...
/**
* The DocCategoryList model module.
* @module model/DocCategoryList
* @version 1.2.0
*/
export default class DocCategoryList {
    /**
    * Constructs a new <code>DocCategoryList</code>.
    * A list of categories that can be applied to a doc.
    * @alias module:model/DocCategoryList
    * @class
    * @param items {Array.<module:model/DocCategory>} Categories for the doc.
    */
    ...
    /**
    * Constructs a <code>DocCategoryList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DocCategoryList} obj Optional instance to populate.
    * @return {module:model/DocCategoryList} The populated <code>DocCategoryList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocCategoryList();
                        
            
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [DocCategory]);
            }
        }
        return obj;
    }
    ...
    * @member {Array.<module:model/DocCategory>} items
    */
    'items' = undefined;


    /**
    * Returns Categories for the doc.
    ...
    */
    ...
    /**
    * Sets Categories for the doc.
    * @param {Array.<module:model/DocCategory>} items Categories for the doc.
    */
    setItems(items) {
        this['items'] = items;
    }
