...
export default class TablesApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Table} and HTTP response
     */
    getTableWithHttpInfo(docId, tableIdOrName) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/docs/{docId}/tables/{tableIdOrName}', 'GET',
     ...
     * Get a table
     * Returns details about a specific table or view.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Table}
     */
    getTable(docId, tableIdOrName) {
      return this.getTableWithHttpInfo(docId, tableIdOrName)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TableList} and HTTP response
     */
    listTablesWithHttpInfo(docId, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'sortBy': opts['sortBy'],
        'tableTypes': this.apiClient.buildCollectionParam(opts['tableTypes'], 'csv')
      };
      let headerParams = {
      };
      let formParams = {
     ...
     * Returns a list of tables in a Coda doc.
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TableList}
     */
    listTables(docId, opts) {
      return this.listTablesWithHttpInfo(docId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
