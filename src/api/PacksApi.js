...
export default class PacksApi {
    ...
    /**
    * Constructs a new PacksApi. 
    * @alias module:api/PacksApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AddPackPermissionResponse} and HTTP response
     */
    addPackPermissionWithHttpInfo(body, packId) {
      let postBody = body;
      ...
      let returnType = AddPackPermissionResponse;

      return this.apiClient.callApi(
        '/packs/{packId}/permissions', 'POST',
     ...
     * Add a permission for Pack
     * Create or modify user, workspace, or global permissions for a given Pack. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AddPackPermissionResponse}
     */
    addPackPermission(body, packId) {
      return this.addPackPermissionWithHttpInfo(body, packId)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CreatePackResponse} and HTTP response
     */
    createPackWithHttpInfo(body) {
      let postBody = body;
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = CreatePackResponse;
     ...
     * Create Pack
     * Creates a new Pack, essentially registering a new Pack id. The contents of the Pack will be uploaded separately. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CreatePackResponse}
     */
    createPack(body) {
      return this.createPackWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DeletePackPermissionResponse} and HTTP response
     */
    deletePackPermissionWithHttpInfo(packId, permissionId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DeletePackPermissionResponse;

      return this.apiClient.callApi(
        '/packs/{packId}/permissions/{permissionId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Delete a permission for Pack
     * Delete user, workspace, or global permissions for a given Pack. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DeletePackPermissionResponse}
     */
    deletePackPermission(packId, permissionId) {
      return this.deletePackPermissionWithHttpInfo(packId, permissionId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Pack} and HTTP response
     */
    getPackWithHttpInfo(packId) {
      let postBody = null;
     ...
     * Get a single Pack
     * Returns a single Pack. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Pack}
     */
    getPack(packId) {
      return this.getPackWithHttpInfo(packId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PackPermissionList} and HTTP response
     */
    getPackPermissionsWithHttpInfo(packId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PackPermissionList;

      return this.apiClient.callApi(
        '/packs/{packId}/permissions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * List permissions for a Pack
     * Get user, workspace, and/or global permissions for a given Pack. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PackPermissionList}
     */
    getPackPermissions(packId) {
      return this.getPackPermissionsWithHttpInfo(packId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PackSummaryList} and HTTP response
     */
    listPacksWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PackSummaryList;
     ...
     * Get the list of accessible Packs. 
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PackSummaryList}
     */
    listPacks(opts) {
      return this.listPacksWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PackAssetUploadCompleteResponse} and HTTP response
     */
    packAssetUploadCompleteWithHttpInfo(packId, packAssetId, packAssetType) {
      let postBody = null;

      let pathParams = {
        'packId': packId,
        'packAssetId': packAssetId,
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PackAssetUploadCompleteResponse;

      return this.apiClient.callApi(
        '/packs/{packId}/assets/{packAssetId}/assetType/{packAssetType}/uploadComplete', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Pack asset upload complete
     * Note the completion of the upload of a Pack asset. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PackAssetUploadCompleteResponse}
     */
    packAssetUploadComplete(packId, packAssetId, packAssetType) {
      return this.packAssetUploadCompleteWithHttpInfo(packId, packAssetId, packAssetType)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CreatePackVersionResponse} and HTTP response
     */
    packVersionUploadCompleteWithHttpInfo(packId, packVersion) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CreatePackVersionResponse;

      return this.apiClient.callApi(
        '/packs/{packId}/versions/{packVersion}/uploadComplete', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Pack version upload complete
     * Note the completion of the upload of a Pack version bundle in order to create that Pack version. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CreatePackVersionResponse}
     */
    packVersionUploadComplete(packId, packVersion) {
      return this.packVersionUploadCompleteWithHttpInfo(packId, packVersion)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PackVersionUploadInfo} and HTTP response
     */
    registerPackVersionWithHttpInfo(packId, packVersion) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PackVersionUploadInfo;

      return this.apiClient.callApi(
        '/packs/{packId}/versions/{packVersion}/register', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Register Pack version
     * Registers a new Pack version. This simply returns a signed url to use for uploading the Pack version definition. Following the completion of the upload, POST to /apis/v1/packs/{packId}/versions/{packVersion} trigger the rest of the creation process. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PackVersionUploadInfo}
     */
    registerPackVersion(packId, packVersion) {
      return this.registerPackVersionWithHttpInfo(packId, packVersion)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/SetPackLiveVersionResponse} and HTTP response
     */
    setPackLiveVersionWithHttpInfo(body, packId) {
      let postBody = body;
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = SetPackLiveVersionResponse;

      return this.apiClient.callApi(
        '/packs/{packId}/liveVersion', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Set live version for Pack
     * Set the Pack version that is installable for users. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/SetPackLiveVersionResponse}
     */
    setPackLiveVersion(body, packId) {
      return this.setPackLiveVersionWithHttpInfo(body, packId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Pack} and HTTP response
     */
    updatePackWithHttpInfo(body, packId) {
      let postBody = body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Pack}
     */
    updatePack(body, packId) {
      return this.updatePackWithHttpInfo(body, packId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PackAssetUploadInfo} and HTTP response
     */
    uploadPackAssetWithHttpInfo(body, packId) {
      let postBody = body;
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = PackAssetUploadInfo;

      return this.apiClient.callApi(
        '/packs/{packId}/uploadAsset', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Upload a Pack asset.
     * Request a signed s3 URL to upload your Pack asset. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PackAssetUploadInfo}
     */
    uploadPackAsset(body, packId) {
      return this.uploadPackAssetWithHttpInfo(body, packId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
