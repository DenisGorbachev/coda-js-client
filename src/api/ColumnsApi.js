...
export default class ColumnsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ColumnDetail} and HTTP response
     */
    getColumnWithHttpInfo(docId, tableIdOrName, columnIdOrName) {
      let postBody = null;
      ...
      let returnType = ColumnDetail;

      return this.apiClient.callApi(
        '/docs/{docId}/tables/{tableIdOrName}/columns/{columnIdOrName}', 'GET',
     ...
     * Get a column
     * Returns details about a column in a table.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ColumnDetail}
     */
    getColumn(docId, tableIdOrName, columnIdOrName) {
      return this.getColumnWithHttpInfo(docId, tableIdOrName, columnIdOrName)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ColumnList} and HTTP response
     */
    listColumnsWithHttpInfo(docId, tableIdOrName, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ColumnList;

      return this.apiClient.callApi(
        '/docs/{docId}/tables/{tableIdOrName}/columns', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Returns a list of columns in a table.
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ColumnList}
     */
    listColumns(docId, tableIdOrName, opts) {
      return this.listColumnsWithHttpInfo(docId, tableIdOrName, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
