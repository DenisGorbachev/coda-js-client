...
export default class DocsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DocumentCreationResult} and HTTP response
     */
    createDocWithHttpInfo(body) {
      let postBody = body;
      ...
      let returnType = DocumentCreationResult;
     ...
     * Create doc
     * Creates a new Coda doc, optionally copying an existing doc. Note that creating a doc requires you to be a Doc Maker in the applicable workspace (or be auto-promoted to one). 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DocumentCreationResult}
     */
    createDoc(body) {
      return this.createDocWithHttpInfo(body)
     ...
     * Delete doc
     * Deletes a doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DocDelete} and HTTP response
     */
    deleteDocWithHttpInfo(docId) {
      let postBody = null;
     ...
     * Delete doc
     * Deletes a doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DocDelete}
     */
    deleteDoc(docId) {
      return this.deleteDocWithHttpInfo(docId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Doc} and HTTP response
     */
    getDocWithHttpInfo(docId) {
      let postBody = null;
     ...
     * Get info about a doc
     * Returns metadata for the specified doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Doc}
     */
    getDoc(docId) {
      return this.getDocWithHttpInfo(docId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DocList} and HTTP response
     */
    listDocsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * Returns a list of Coda docs accessible by the user. These are returned in the same order as on the docs page: reverse chronological by the latest event relevant to the user (last viewed, edited, or shared). 
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DocList}
     */
    listDocs(opts) {
      return this.listDocsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
