...
export default class PermissionsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AddPermissionResult} and HTTP response
     */
    addPermissionWithHttpInfo(body, docId) {
      let postBody = body;
      ...
      let returnType = AddPermissionResult;

      return this.apiClient.callApi(
        '/docs/{docId}/acl/permissions', 'POST',
     ...
     * Add permission
     * Adds a new permission to the doc. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AddPermissionResult}
     */
    addPermission(body, docId) {
      return this.addPermissionWithHttpInfo(body, docId)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DeletePermissionResult} and HTTP response
     */
    deletePermissionWithHttpInfo(docId, permissionId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DeletePermissionResult;

      return this.apiClient.callApi(
        '/docs/{docId}/acl/permissions/{permissionId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Delete permission
     * Deletes an existing permission. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DeletePermissionResult}
     */
    deletePermission(docId, permissionId) {
      return this.deletePermissionWithHttpInfo(docId, permissionId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    getPermissionsWithHttpInfo(docId, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/docs/{docId}/acl/permissions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    getPermissions(docId, opts) {
      return this.getPermissionsWithHttpInfo(docId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AclMetadata} and HTTP response
     */
    getSharingMetadataWithHttpInfo(docId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AclMetadata;

      return this.apiClient.callApi(
        '/docs/{docId}/acl/metadata', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Get sharing metadata
     * Returns metadata associated with sharing for this Coda doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AclMetadata}
     */
    getSharingMetadata(docId) {
      return this.getSharingMetadataWithHttpInfo(docId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
