...
export default class PagesApi {
    ...
    */
     ...
     */
    getPageWithHttpInfo(docId, pageIdOrName) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/docs/{docId}/pages/{pageIdOrName}', 'GET',
     ...
     */
    getPage(docId, pageIdOrName) {
      return this.getPageWithHttpInfo(docId, pageIdOrName)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageList} and HTTP response
     */
    listPagesWithHttpInfo(docId, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * Returns a list of pages in a Coda doc.
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageList}
     */
    listPages(docId, opts) {
      return this.listPagesWithHttpInfo(docId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageUpdateResult} and HTTP response
     */
    updatePageWithHttpInfo(body, docId, pageIdOrName) {
      let postBody = body;
      ...
      let accepts = ['application/json'];
      let returnType = PageUpdateResult;

      return this.apiClient.callApi(
        '/docs/{docId}/pages/{pageIdOrName}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Update a page
     * Update properties for a page.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageUpdateResult}
     */
    updatePage(body, docId, pageIdOrName) {
      return this.updatePageWithHttpInfo(body, docId, pageIdOrName)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
