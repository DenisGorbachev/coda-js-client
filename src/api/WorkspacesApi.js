...
export default class WorkspacesApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ChangeRoleResult} and HTTP response
     */
    changeUserRoleWithHttpInfo(body, workspaceId) {
      let postBody = body;
      ...
      let returnType = ChangeRoleResult;

      return this.apiClient.callApi(
        '/workspaces/{workspaceId}/users/role', 'POST',
     ...
     * Updates user role
     * Updates the workspace user role of a user that matches the parameters. Only succeeds if the requesting user has admin permissions in the workspace. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ChangeRoleResult}
     */
    changeUserRole(body, workspaceId) {
      return this.changeUserRoleWithHttpInfo(body, workspaceId)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/WorkspaceMembersList} and HTTP response
     */
    listWorkspaceMembersWithHttpInfo(workspaceId, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'includedRoles': this.apiClient.buildCollectionParam(opts['includedRoles'], 'csv'),
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = WorkspaceMembersList;

      return this.apiClient.callApi(
        '/workspaces/{workspaceId}/users', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Returns a list of members in the given workspace. This list will be ordered with the requesting user first and then ordered by role. 
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/WorkspaceMembersList}
     */
    listWorkspaceMembers(workspaceId, opts) {
      return this.listWorkspaceMembersWithHttpInfo(workspaceId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetWorkspaceRoleActivity} and HTTP response
     */
    listWorkspaceRoleActivityWithHttpInfo(workspaceId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetWorkspaceRoleActivity;

      return this.apiClient.callApi(
        '/workspaces/{workspaceId}/roles', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * List workspace roles
     * Returns a list of the counts of users over time by role for the workspace. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetWorkspaceRoleActivity}
     */
    listWorkspaceRoleActivity(workspaceId) {
      return this.listWorkspaceRoleActivityWithHttpInfo(workspaceId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
