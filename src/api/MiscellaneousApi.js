...
export default class MiscellaneousApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MutationStatus} and HTTP response
     */
    getMutationStatusWithHttpInfo(requestId) {
      let postBody = null;
      ...
      let returnType = MutationStatus;

      return this.apiClient.callApi(
        '/mutationStatus/{requestId}', 'GET',
     ...
     * Get mutation status
     * Get the status for an asynchronous mutation to know whether or not it has been completed. Each API endpoint that mutates a document will return a request id that you can pass to this endpoint to check the completion status. Status information is not guaranteed to be available for more than one day after the mutation was completed. It is intended to be used shortly after the request was made. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MutationStatus}
     */
    getMutationStatus(requestId) {
      return this.getMutationStatusWithHttpInfo(requestId)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiLink} and HTTP response
     */
    resolveBrowserLinkWithHttpInfo(url, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'url': url,
        'degradeGracefully': opts['degradeGracefully']
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ApiLink;

      return this.apiClient.callApi(
        '/resolveBrowserLink', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Given a browser link to a Coda object, attempts to find it and return metadata that can be used to get more info on it. Returns a 400 if the URL does not appear to be a Coda URL or a 404 if the resource cannot be located with the current credentials. 
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiLink}
     */
    resolveBrowserLink(url, opts) {
      return this.resolveBrowserLinkWithHttpInfo(url, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
