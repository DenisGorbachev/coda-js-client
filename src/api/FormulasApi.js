...
export default class FormulasApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Formula} and HTTP response
     */
    getFormulaWithHttpInfo(docId, formulaIdOrName) {
      let postBody = null;

      let pathParams = {
        'docId': docId,
        'formulaIdOrName': formulaIdOrName
      };
      let queryParams = {
      };
      let headerParams = {
      ...
      return this.apiClient.callApi(
        '/docs/{docId}/formulas/{formulaIdOrName}', 'GET',
     ...
     * Get a formula
     * Returns info on a formula.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Formula}
     */
    getFormula(docId, formulaIdOrName) {
      return this.getFormulaWithHttpInfo(docId, formulaIdOrName)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FormulaList} and HTTP response
     */
    listFormulasWithHttpInfo(docId, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * Returns a list of named formulas in a Coda doc.
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FormulaList}
     */
    listFormulas(docId, opts) {
      return this.listFormulasWithHttpInfo(docId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
