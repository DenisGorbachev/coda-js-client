...
export default class PublishingApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DocCategoryList} and HTTP response
     */
    listCategoriesWithHttpInfo() {
      ...
      let returnType = DocCategoryList;
     ...
     * Get doc categories
     * Gets all available doc categories.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DocCategoryList}
     */
    listCategories() {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PublishResult} and HTTP response
     */
    publishDocWithHttpInfo(body, docId) {
      let postBody = body;
      ...
      let accepts = ['application/json'];
      let returnType = PublishResult;

      return this.apiClient.callApi(
        '/docs/{docId}/publish', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Publish doc
     * Update publish settings for a doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PublishResult}
     */
    publishDoc(body, docId) {
      return this.publishDocWithHttpInfo(body, docId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * Unpublish doc
     * Unpublishes a doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UnpublishResult} and HTTP response
     */
    unpublishDocWithHttpInfo(docId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UnpublishResult;

      return this.apiClient.callApi(
        '/docs/{docId}/publish', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Unpublish doc
     * Unpublishes a doc.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UnpublishResult}
     */
    unpublishDoc(docId) {
      return this.unpublishDocWithHttpInfo(docId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
