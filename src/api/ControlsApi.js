...
/**
* Controls service.
* @module api/ControlsApi
* @version 1.2.0
*/
export default class ControlsApi {

    /**
    * Constructs a new ControlsApi. 
    * @alias module:api/ControlsApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Control} and HTTP response
     */
    getControlWithHttpInfo(docId, controlIdOrName) {
      let postBody = null;
      ...
      let returnType = Control;

      return this.apiClient.callApi(
        '/docs/{docId}/controls/{controlIdOrName}', 'GET',
     ...
     * Get a control
     * Returns info on a control.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Control}
     */
    getControl(docId, controlIdOrName) {
      return this.getControlWithHttpInfo(docId, controlIdOrName)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ControlList} and HTTP response
     */
    listControlsWithHttpInfo(docId, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ControlList;

      return this.apiClient.callApi(
        '/docs/{docId}/controls', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * Returns a list of controls in a Coda doc.
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ControlList}
     */
    listControls(docId, opts) {
      return this.listControlsWithHttpInfo(docId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
