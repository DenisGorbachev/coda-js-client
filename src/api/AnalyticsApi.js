...
export default class AnalyticsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DocAnalyticsCollection} and HTTP response
     */
    listDocAnalyticsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = DocAnalyticsCollection;
     ...
     * Returns analytics data for available docs per day in reverse chronological order. 
     * @param {Object} opts Optional parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DocAnalyticsCollection}
     */
    listDocAnalytics(opts) {
      return this.listDocAnalyticsWithHttpInfo(opts)
